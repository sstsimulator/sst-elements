...
public:
    ...
    SST_ELI_DOCUMENT_PARAMS(
        ...
        {"data_path", "Directory holding the adjacency list generated by the python module."},
    )
    ...
    std::string data_path; //directory holding the adjacency list written by the python module
