...
####
    ...
    def test_memH_dir3levelsweep(self, testnum, omp_app, L1_size, L1_repl, L1_asso, L2_size, L2_repl, L2_asso, L2_mshr, L3_size, L3_repl, L3_asso, L3_mshr, test_type):
        self._checkSkipConditions(testnum)

        log_debug("Running memH dir3levelsweep #{0:04}; App={13}; L1:size={1}; repl={2}; asso={3}; L2:size={4}; repl={5}; asso={6}; mshr={7}; L3:size={8}; repl={9}; asso={10}; mshr={11}; test_type={12}".format(testnum, omp_app, L1_size, L1_repl, L1_asso, L2_size, L2_repl, L2_asso, L2_mshr, L3_size, L3_repl, L3_asso, L3_mshr, test_type))
        self.memH_dir3levelsweek_test_template(testnum, omp_app, L1_size, L1_repl, L1_asso, L2_size, L2_repl, L2_asso, L2_mshr, L3_size, L3_repl, L3_asso, L3_mshr, test_type)

####

    def memH_dir3levelsweek_test_template(self, testnum, omp_app, L1_size, L1_repl, L1_asso, L2_size, L2_repl, L2_asso, L2_mshr, L3_size, L3_repl, L3_asso, L3_mshr, test_type):
