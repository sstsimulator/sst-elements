...
bool Cache::evictInHigherLevelCaches(CacheLine* wbCacheLine, Addr requestBaseAddr) throw(stallException){
...
bool Cache::retryRequestLater(MemEvent* event, Addr baseAddr){
    mshr_->removeElement(baseAddr, event);
