...
// TODO: Weili: Need to refer to GPGPU-Sim libcuda for these 
// TODO: https://github.com/accel-sim/gpgpu-sim_distribution/blob/a0c12f5d63504c67c8bdfb1a6cc689b4ab7867a6/libcuda/cuda_runtime_api.cc#L577
...
__host__ cudaError_t CUDARTAPI cudaLaunchKernel(const void *hostFun,
                                                ...
                                                size_t sharedMem,
                                                cudaStream_t stream) {
    // TODO: Need to get the function parameter size and offset, which is stored inside GPGPU-Sim
    return cudaSuccess;
}
