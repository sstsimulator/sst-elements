...
//template<class I, class O>
void c_CtrlSubComponent<I,O>::sendRequest() {
    assert(m_nextSubComponent==NULL);
...
//template<class I, class O>
void c_CtrlSubComponent<I,O>::setNextSubComponent(c_CtrlSubComponent<I,O>* nextSubComp){
    assert(nextSubComp==NULL);
    m_nextSubComponent=nextSubComp;
    //std::cout<<"m_cmdReqQ.size():"<<m_cmdReqQ.size()<<std::endl;
}
