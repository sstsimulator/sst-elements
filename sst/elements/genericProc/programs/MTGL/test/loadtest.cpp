...
/****************************************************************************/
/*! \file loadtest.cpp
    \brief Use loadGraph in loadmap.c to load node and edge memory map files
           from summary file and print vertex and edge sets from memory maps.
