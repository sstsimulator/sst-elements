...
d0_clink = dirctrl0.setSubComponent("cpulink", "memHierarchy.MemNIC")
d0_mlink = dirctrl0.setSubComponent("memlink", "memHierarchy.MemLink")
d0_clink.addParams({
    "group" : 2,
    "network_bw" : netBW,
...
d1_clink = dirctrl1.setSubComponent("cpulink", "memHierarchy.MemNIC")
d1_mlink = dirctrl1.setSubComponent("memlink", "memHierarchy.MemLink")
d1_clink.addParams({
    "group" : 2,
    "network_bw" : netBW,
...
link_bus_l3cache.connect( (comp_n2_bus, "low_network_0", "500ps"), (l3_clink, "port", "500ps") )
link_cache_net_0 = sst.Link("link_cache_net_0")
link_cache_net_0.connect( (l3_mlink, "port", "500ps"), (comp_chiprtr, "port2", "500ps") )
link_dir_net_0 = sst.Link("link_dir_net_0")
link_dir_net_0.connect( (comp_chiprtr, "port0", "200ps"), (d0_clink, "port", "200ps") )
link_dir0_mem_link = sst.Link("link_dir0_mem_link")
link_dir0_mem_link.connect( (d0_mlink, "port", "500ps"), (comp_memory0, "direct_link", "500ps") )
link_dir_net_1 = sst.Link("link_dir_net_1")
link_dir_net_1.connect( (comp_chiprtr, "port1", "200ps"), (d1_clink, "port", "200ps") )
link_dir1_mem_link = sst.Link("link_dir1_mem_link")
link_dir1_mem_link.connect( (d1_mlink, "port", "500ps"), (comp_memory1, "direct_link", "500ps") )
