...
class EmberNetworkIOCancelEvent : public EmberNetworkIOEvent {
public:
    EmberNetworkIOCancelEvent(NetworkIO::Interface& api, Output* output,
    ...
    ~EmberNetworkIOCancelEvent() {}

    std::string getName() { return "NetworkIOCancel"; }
