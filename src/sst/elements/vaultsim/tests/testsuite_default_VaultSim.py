...
#####
    ...
    def test_VaultSim_sdl1(self):
        self.vaultsim_test_template("sdl1")

    def test_VaultSim_sdls(self):
        self.vaultsim_test_template("sdl2")

#####

    def vaultsim_test_template(self, testcase):
        ...
        testDataFileName="test_VaultSim_{0}".format(testcase)
        ...
        if os_test_file(errfile, "-s"):
            log_testing_note("VaultSim test {0} has a Non-Empty Error File {1}".format(testDataFileName, errfile))
