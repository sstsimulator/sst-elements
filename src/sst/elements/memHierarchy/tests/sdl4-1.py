...
link_cpu0_l1cache_link.connect( (iface0, "lowlink", "1000ps"), (comp_c0_l1cache, "highlink", "1000ps") )
link_c0_l1_l2_link = sst.Link("link_c0_l1_l2_link")
link_c0_l1_l2_link.connect( (comp_c0_l1cache, "lowlink", "1000ps"), (comp_bus, "highlink0", "10000ps") )
link_cpu1_l1cache_link = sst.Link("link_cpu1_l1cache_link")
link_cpu1_l1cache_link.connect( (iface1, "lowlink", "1000ps"), (comp_c1_l1cache, "highlink", "1000ps") )
link_c1_l1_l2_link = sst.Link("link_c1_l1_l2_link")
link_c1_l1_l2_link.connect( (comp_c1_l1cache, "lowlink", "1000ps"), (comp_bus, "highlink1", "10000ps") )
link_bus_l2cache = sst.Link("link_bus_l2cache")
link_bus_l2cache.connect( (comp_bus, "lowlink0", "10000ps"), (comp_l2cache, "highlink", "1000ps") )
