...
# GLOBAL PARAMS
config_file = "hbm_pseudo_1h.cfg"
config_file_openbank = "hbm_pseudo_1h_openbank.cfg"
...
# sst --lib-path=.libs/ tests/test_txntrace4.py --model-options="--configfile=hbm_pseudo_1h_openbank.cfg --tracefile=traces/sst-CramSim-trace_verimem_2_W.trc"
