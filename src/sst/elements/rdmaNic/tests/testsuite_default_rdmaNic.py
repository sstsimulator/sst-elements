...
#####
    ...
    def rdmaNic_test_template(self, testnum, testname, sdlfile, elftestdir, elffile, testtimeout=120):
        ...
        self.assertTrue(os_outfileexists, "RdmaNic test outfile-os not found in directory {0}".format(outdir))
        self.assertTrue(os_errfileexists, "RdmaNic test errfile-os not found in directory {0}".format(outdir))
        ...
        self.assertTrue(cmp_result, "RdmaNic os output file {0} does not match reference output file {1}".format(os_outfile, ref_outfile))
        ...
        if (cmp_result == False):
            ...
            log_failure(oscmd)
            log_failure(diffdata)
        self.assertTrue(cmp_result, "RdmaNic os error file {0} does not match reference error file {1}".format(os_outfile, ref_outfile))
