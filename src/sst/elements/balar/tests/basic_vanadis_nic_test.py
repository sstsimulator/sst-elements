...
node_os.addParams({
    ...
    "executable" : os.getenv("VANADIS_EXE", ""),
    "app.env_count" : 2,
...
chiprtr = sst.Component("chiprtr_nic", "merlin.hr_router")
chiprtr.addParams({
      "xbar_bw" : "1GB/s",
      "id" : "0",
      "input_buf_size" : "1KB",
...
link_cpu_rtr.connect( (cpu_dcache_nic, "port", "1000ps"), (chiprtr, "port0", "1000ps") )

link_l1d_rtr = sst.Link("link_l1d")
link_l1d_rtr.connect( (l1d_nic, "port", '1000ps'), (chiprtr, "port1", "1000ps") )
## end
