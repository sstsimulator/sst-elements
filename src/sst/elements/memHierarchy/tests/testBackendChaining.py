...
comp_memory.addParams({
    ...
    "backend.backend.backend.tRCD" : 3,
    "backend.backend.backend.tRP" : 3,
    "backend.backend.backend.cycle_time" : "5ns",
    "backend.backend.backend.row_size" : "8KiB",
    "backend.backend.backend.row_policy" : "open"
})
