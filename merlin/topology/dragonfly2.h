...
class topo_dragonfly2_event : public internal_router_event, public SST::Core::Serialization::serializable_type<topo_dragonfly2_event> {
...
private:
    ImplementSerializable(topo_dragonfly2_event)
