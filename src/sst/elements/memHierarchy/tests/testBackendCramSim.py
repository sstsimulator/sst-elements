...
link_c1_l1cache.connect( (iface, "port", "1000ps"), (comp_c1_l1cache, "high_network_0", "1000ps") )
...
link_c2_l1cache.connect( (iface, "port", "1000ps"), (comp_c2_l1cache, "high_network_0", "1000ps") )
...
link_c3_l1cache.connect( (iface, "port", "1000ps"), (comp_c3_l1cache, "high_network_0", "1000ps") )
