...
class SwitchingFilter : public ActiveRingElement
{
	private:
		...
		vector< vector< vector<double> > > lossMatrix;
		...
		virtual double GetCrossTalk(int indexIn, int indexOut, double wavelength = 0);
