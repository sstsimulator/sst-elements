# Test handshake with vanadis cpu using a simple program
# Run script: sst testVanadisHandShake.py --model-options="-c ariel-gpu-v100.cfg -v" > tmp.out 2>&1
# TODO Configure the vanadis cpu here
import sst
import os
try:
    import ConfigParser
...
cpu_nic = dcache_if.setSubComponent("memlink", "memHierarchy.MemNIC")
