...
comp_memory.addParams({
    ...
    "backing" : "none",
    "backend" : "memHierarchy.HBMpagedMultiMemory",
...
link_cache_net_0.connect( (l3_mlink, "port", "1000ps"), (comp_chiprtr, "port1", "1000ps") )
link_dir_net_0 = sst.Link("link_dir_net_0")
link_dir_net_0.connect( (comp_chiprtr, "port0", "1000ps"), (dir_clink, "port", "1000ps") )
