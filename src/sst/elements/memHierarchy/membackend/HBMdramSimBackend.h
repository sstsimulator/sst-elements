...
/* Element Library Info */
    SST_ELI_REGISTER_SUBCOMPONENT(HBMDRAMSimMemory, "memHierarchy", "HBMDRAMSimMemory", SST_ELI_ELEMENT_VERSION(1,0,0), "HBM DRAMSim-driven memory timings", SST::MemHierarchy::SimpleMemBackend)
