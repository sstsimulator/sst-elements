...
dir_link = dirctrl.setSubComponent("cpulink", "memHierarchy.MemNIC")
dir_link.addParams({
    "group" : 2,
    "network_bw" : "25GB/s",
...
mem_link = memory.setSubComponent("cpulink", "memHierarchy.MemNIC")
mem_link.addParams({
    "group" : 3,
#    "debug" : 1,
    "debug_level" : 10,
...
link_bus_l3cache.connect( (comp_n2_bus, "low_network_0", "10000ps"), (l3_clink, "port", "10000ps") )
link_cache_net_0 = sst.Link("link_cache_net_0")
link_cache_net_0.connect( (l3_mlink, "port", "10000ps"), (comp_chiprtr, "port1", "2000ps") )
link_dir_net_0 = sst.Link("link_dir_net_0")
link_dir_net_0.connect( (comp_chiprtr, "port0", "2000ps"), (dir_link, "port", "2000ps") )
link_mem_net_0 = sst.Link("link_mem_net_0")
link_mem_net_0.connect( (comp_chiprtr, "port2", "2000ps"), (mem_link, "port", "2000ps") )
