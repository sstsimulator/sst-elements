...
/* Element Library Info */
    SST_ELI_REGISTER_SUBCOMPONENT(GOBLINHMCSimBackend, "memHierarchy", "GOBLINHMCSimBackend", SST_ELI_ELEMENT_VERSION(1,0,0), "GOBLIN HMC Simulator driven memory timings", "SST::MemHierarchy::MemBackend")
