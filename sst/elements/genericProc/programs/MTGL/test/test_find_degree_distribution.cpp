...
/****************************************************************************/
/*! \file test_find_degree_distribution.cpp
...
#include "test_find_degree_distribution.h"
...
int main(int argc, char* argv[])
{
  ...
  if (find(kti.algs, kti.algCount, "dd"))
  {
    if (kti.graph_type != MMAP)
    {
      test_find_degree_distribution<graph_adapter>(ga);
    }
  }
}
