...
// Constructor
simpleTracer::simpleTracer( ComponentId_t id, Params& params ): Component( id ) {
    ...
    registerClock( frequency, new Clock::Handler<simpleTracer>(this, &simpleTracer::clock) );
...
void simpleTracer::FinalStats(FILE *fp, unsigned int numBins){
    // print stats
...
void simpleTracer::PrintAddrHistogram(FILE *fp, vector<SST::MemHierarchy::Addr> bucketList){
