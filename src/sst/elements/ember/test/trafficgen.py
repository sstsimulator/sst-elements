...
if __name__ == "__main__":
    ...
    ep.addMotif("Init")
    ep.addMotif("TrafficGen pattern=random maxMessageSize=1024 messageSizeMean=512 messageSizeStdDev=512 computeDelay=10 hotSpots=1 hotSpotsRatio=100 stopIterations=100 debugLevel=0")
    ep.addMotif("Fini")
