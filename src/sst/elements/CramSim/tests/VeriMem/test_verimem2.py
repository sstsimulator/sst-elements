...
def run_verimem(config_file, trace_file):
    # set the command
    sstCmd = "sst --lib-path=../.libs/ test_txntrace.py --model-options=\""
...
# sst --lib-path=.libs/ test_txntrace.py --model-options="--configfile=ddr4_verimem_openbank.cfg traceFile=../traces/sst-CramSim-trace_verimem_2_W.trc"
