...
link_l2_scratch0.connect( (comp_l2_0, "low_network_0", "100ps"), (scratchlink0, "port", "100ps") )
link_l2_scratch1 = sst.Link("link_cpu1_scratch1")
link_l2_scratch1.connect( (comp_l2_1, "low_network_0", "100ps"), (scratchlink1, "port", "100ps") )
