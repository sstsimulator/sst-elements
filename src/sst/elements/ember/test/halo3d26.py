...
def getParams( ranks, flopsPerRank ):
	...
	print "Halo3D26 ranks={0} flopsPerRank={1}".format(ranks,flopsPerRank)
	...
	motifArgs += " flopspercell=" + str(flopspercell)
	...
	#PARAMETER 13 = arg.datatype_width (Specify the size of a single variable, single grid point, typically 8 for double, 4 for float, default is 8 (double). This scales message size to ensure 
