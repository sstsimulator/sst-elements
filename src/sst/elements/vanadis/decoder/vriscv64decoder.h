...
public:
    ...
    void tick(SST::Output* output, uint64_t cycle) override
    {
        ...
        for ( uint16_t i = 0; i < max_decodes_per_cycle; ++i ) {
            if ( ! thread_rob->full() ) {
                if ( ins_loader->hasBundleAt(ip) ) {
                    ...
                    if(output->getVerboseLevel() >= 16) {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> Found uop bundle for ip=0x%" PRI_ADDR ", loading from cache...\n", ip);
                    }
                    ...
                    if ( bundle->getInstructionCount() < (thread_rob->capacity() - thread_rob->size()) ) {
                        ...
                        if(output->getVerboseLevel() >= 16) {
                            output->verbose(
                                CALL_INFO, 16,VANADIS_DBG_DECODER_FLG, "----> branch? %s, ip=0x%" PRI_ADDR " + inc=%" PRIu64 " = new-ip=0x%" PRI_ADDR "\n",
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> Not enough space in the ROB, will stall this cycle.\n");
                    ...
                    if ( predecode_bytes ) {
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> performing a decode for ip=0x%" PRI_ADDR "\n", ip);
                        if((judgeThr(hw_thr)) & implement_simt)
                            decode_simt(output, ip, temp_ins, decoded_bundle);
                        else
                            decode(output, ip, temp_ins, decoded_bundle);

                        if(output->getVerboseLevel() >= 16) {
                            output->verbose(
                                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> bundle generates %" PRIu32 " micro-ops\n",
        ...
        if(output->getVerboseLevel() >= 16) {
            output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> cycle is completed, ip=0x%" PRI_ADDR "\n", ip);
        }
    }
...
protected:
    ...
    void decode(SST::Output* output, const uint64_t ins_address, const uint32_t ins, VanadisInstructionBundle* bundle)
    {
        ...
        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "[decode] -> ins-bytes: 0x%08x\n", ins);
        ...
        if ( (ins & 0x3) == 0x3 ) {
            output->verbose(
                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "[decode] -> 32bit format / ins-op-code-family: %" PRIu32 " / 0x%x\n", op_code,
                op_code);
            ...
            case 0x3:
            {
                ...
                case 0:
                {
                    // LB
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> LB %" PRIu16 " <- %" PRIu16 " %" PRId64 "\n", rd, rs1, simm64);
                ...
                case 1:
                {
                    // LH
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> LH %" PRIu16 " <- %" PRIu16 " %" PRId64 "\n", rd, rs1, simm64);
                ...
                case 2:
                {
                    // LW
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> LW %" PRIu16 " <- %" PRIu16 " %" PRId64 "\n", rd, rs1, simm64);
                ...
                case 3:
                {
                    // LD
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> LD %" PRIu16 " <- %" PRIu16 " %" PRId64 "\n", rd, rs1, simm64);
                ...
                case 4:
                {
                    // LBU
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> LBU %" PRIu16 " <- %" PRIu16 " %" PRId64 "\n", rd, rs1, simm64);
                ...
                case 5:
                {
                    // LHU
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> LHU %" PRIu16 " <- %" PRIu16 " %" PRId64 "\n", rd, rs1, simm64);
                ...
                case 6:
                {
                    // LWU
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> LWU %" PRIu16 " <- %" PRIu16 " %" PRId64 "\n", rd, rs1, simm64);
            ...
            case 0x7:
            {
                ...
                case 0x2:
                {
                    // FLW
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> FLW %" PRIu16 " <- memory[ %" PRIu16 " + %" PRId64 " ]\n", rd, rs1,
                        simm64);
                    bundle->addInstruction(new VanadisLoadInstruction(
                        ins_address, hw_thr, options, rs1, simm64, rd, 4, true, MEM_TRANSACTION_NONE,
                        LOAD_FP_REGISTER));
                ...
                case 0x3:
                {
                    // FLD
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> FLD %" PRIu16 " <- memory[ %" PRIu16 " + %" PRId64 " ]\n", rd, rs1,
                        simm64);
                    bundle->addInstruction(new VanadisLoadInstruction(
                        ins_address, hw_thr, options, rs1, simm64, rd, 8, true, MEM_TRANSACTION_NONE,
                        LOAD_FP_REGISTER));
            ...
            case 0x13:
            {
                ...
                output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> immediate-arith func: %" PRIu32 "\n", func_code);
                ...
                case 0:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "------> ADDI %" PRIu16 " <- %" PRIu16 " + %" PRId64 "\n", rd, rs1, simm64);
                ...
                case 1:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "------> func_code6 = %" PRIu32 " / shift = %" PRIu32 " (0x%" PRIx32 ")\n",
                ...
                case 5:
                {
                    ...
                    {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> SRLI %" PRIu16 " <- %" PRIu16 " >> %" PRIu32 "\n", rd, rs1,
                            shift_by);
                        bundle->addInstruction(
                    ...
                    {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> SRAI %" PRIu16 " <- %" PRIu16 " >> %" PRIu32 "\n", rd, rs1,
                            shift_by);
                        bundle->addInstruction(
            ...
            case 0x33:
            {
                ...
                output->verbose(
                    CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> decode R-type, func_code3=%" PRIu32 " / func_code7=%" PRIu32 "\n",
                ...
                case 0:
                {
                    ...
                    {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> ADD %" PRIu16 " <- %" PRIu16 " + %" PRIu16 " hw_thr=%d\n", rd, rs1, rs2, hw_thr);
                        // ADD
                    ...
                    case 1:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> MUL %" PRIu16 " <- %" PRIu16 " + %" PRIu16 "\n", rd, rs1, rs2);
                    ...
                    {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> SUB %" PRIu16 " <- %" PRIu16 " - %" PRIu16 "\n", rd, rs1, rs2);
                        // SUB
                ...
                case 1:
                {
                    ...
                    case 0:
                    {
                        // SLL
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> SLL %" PRIu16 " <- %" PRIu16 " << %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(
                    ...
                    case 1:
                    {
                        // MULH
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> MULH %" PRIu16 " <- %" PRIu16 " + %" PRIu16 "\n", rd, rs1, rs2);
                ...
                case 2:
                {
                    ...
                    {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> SLT %" PRIu16 " <-  %" PRIu16 " < %" PRIu16 "\n", rd, rs1,
                            rs2);
                        // SLT
                        bundle->addInstruction(
                    ...
                    case 1:
                    {
                        // MULHSU
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> MULHSU %" PRIu16 " <- %" PRIu16 " + %" PRIu16 "\n", rd, rs1, rs2);
                ...
                case 3:
                {
                    ...
                    {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> SLTU %" PRIu16 " <-  %" PRIu16 " < %" PRIu16 "\n", rd, rs1,
                            rs2);
                        // SLTU
                        bundle->addInstruction(
                            new VanadisSetRegCompareInstruction<
                    ...
                    case 0x1:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> MULHU %" PRIu16 " <- %" PRIu16 " + %" PRIu16 "\n", rd, rs1, rs2);
                ...
                case 4:
                {
                    ...
                    case 0x0:
                    {
                        // XOR
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> XOR %" PRIu16 " <-  %" PRIu16 " ^ %" PRIu16 "\n", rd, rs1, rs2);
                    ...
                    case 1:
                    {
                        // DIV
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> DIV %" PRIu16 " <-  %" PRIu16 " / %" PRIu16 "\n", rd, rs1, rs2);
                ...
                case 5:
                {
                    ...
                    case 0:
                    {
                        // SRL
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> SRL %" PRIu16 " <-  %" PRIu16 " >> %" PRIu16 "\n", rd, rs1,
                            rs2);
                        bundle->addInstruction(
                    ...
                    case 1:
                    {
                        // DIVU
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> DIVU %" PRIu16 " <-  %" PRIu16 " / %" PRIu16 "\n", rd, rs1,
                            rs2);
                    ...
                    case 32:
                    {
                        // SRA
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> SRA %" PRIu16 " <- %" PRIu16 " >> %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(
                ...
                case 6:
                {
                    ...
                    case 0x0:
                    {
                        // OR
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> OR %" PRIu16 " <- %" PRIu16 " | %" PRIu16 "\n", rd, rs1, rs2);
                    ...
                    case 0x1:
                    {
                        // REM
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> REM %" PRIu16 " <- %" PRIu16 " %% %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(
                ...
                case 7:
                {
                    ...
                    case 0x0:
                    {
                        // AND
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> AND %" PRIu16 " <- %" PRIu16 " & %" PRIu16 "\n", rd, rs1, rs2);
                    ...
                    case 0x1:
                    {
                        // REMU
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> REMU %" PRIu16 " <- %" PRIu16 " %% %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(
            ...
            case 0x37:
            {
                ...
                output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> LUI %" PRIu16 " <- %#" PRIx32 "\n", rd, uimm32);
            ...
            case 0x1B:
            {
                ...
                case 0x0:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> ADDIW %" PRIu16 " <- %" PRIu16 " + %" PRId64 "\n", rd, rs1,
                        addiw_imm);
                ...
                case 0x1:
                {
                    ...
                    case 0x0:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> SLLIW %" PRIu16 " <- %" PRIu16 " << %" PRIu16 " (%#" PRIx16 ")\n", rd,
                            rs1, rs2, rs2);
                        bundle->addInstruction(
                ...
                case 0x5:
                {
                    ...
                    case 0x0:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> SRLIW %" PRIu16 " <- %" PRIu16 " << %" PRIu16 " (%#" PRIx16 ")\n", rd,
                            rs1, rs2, rs2);
                        bundle->addInstruction(
                    ...
                    case 32:
                    {
                        ...
                        // SRAIW
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> SRAIW %" PRIu16 " <- %" PRIu16 " << %" PRIu16 " (%#" PRIx16 ")\n", rd,
                            rs1, rs2, rs2);
                        bundle->addInstruction(
            ...
            case 0x63:
            {
                ...
                case 0:
                {
                    // BEQ
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> BEQ %" PRIu16 " == %" PRIu16 " / offset: %" PRId64 "\n", rs1, rs2,
                        simm64);
                ...
                case 4:
                {
                    // BLT
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> BLT %" PRIu16 " < %" PRIu16 " / offset: %" PRId64 "\n", rs1, rs2,
                        simm64);
                ...
                case 5:
                {
                    // BGE
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> BGE %" PRIu16 " >= %" PRIu16 " / offset: %" PRId64 "\n", rs1, rs2,
                        simm64);
            ...
            case 0x73:
            {
                ...
                if ( (0 == rd) && (0 == rs1) && (0 == func_code) ) {
                    ...
                    case 0x0: // SCALL
                    {
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "------> ECALL/SYSCALL\n");
                    ...
                    output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> %s: ins: 0x%" PRI_ADDR " / %#" PRIx64 " / rd: %" PRIu16 " / rs1: %" PRIu16 "\n", 
                    ...
                    switch ( uimm64 ) 
                    {
                        case 0x1: // FSFLAGS
                        {
                            output->verbose( CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----->  FFLAGS: %" PRIu64 " / rd: %" PRIu16 " / rs1: %" PRIu16 "\n", uimm64, rd, rs1);
                        ...
                        case 0x2: // FSRM
                        {
                            output->verbose( CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----->  FRM: %" PRIu64 " / rd: %" PRIu16 " / rs1: %" PRIu16 "\n", uimm64, rd, rs1);
                        ...
                        case 0x3: // FCSR
                        {
                            output->verbose( CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCSR: %" PRIu64 " / rd: %" PRIu16 " / rs1: %" PRIu16 "\n", uimm64, rd, rs1);
            ...
            case 0x3B:
            {
                ...
                case 6:
                {
                    ...
                    case 0x1:
                    {
                        // REMW
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> REMW %" PRIu16 " <- %" PRIu16 " %% %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(
                ...
                case 7:
                {
                    ...
                    case 0x1:
                    {
                        // REMUW
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> REMUW %" PRIu16 " <- %" PRIu16 " %% %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(
				...
				case 0xF:
			   {
                    ...
                    switch ( func_code3 ) {
                        case 0x0:
                        {
					        ...
					        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> FENCE\n");
            ...
            case 0x2F:
            {
                ...
                case AMO_SWAP:
                {
                    if(LIKELY(op_width != 0)) {
                        // AMO.SWAP
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG,
                    ...
                    if(LIKELY(op_width != 0)) {
                        ...
                        case AMO_ADD:
                            // bundle->addInstruction( new VanadisAddInstruction<int64_t>( ins_address, hw_thr, options, 32, 34, rs2));
                             output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> AMO_ADD %" PRIu16 " <- %" PRIu16 " + %" PRIu16 " hw_thr=%d\n", 32, 32, rs2, hw_thr);
                             
                                    bundle->addInstruction(
                                        new VanadisAddInstruction<int64_t>(
                                           ins_address, hw_thr, options, 32, 34, rs2));
                            break;
                        case AMO_XOR:
                ...
                case LR:
                {
                    if ( rs2 == 0 ) {
                        ...
                        if(LIKELY(op_width != 0)) {
                            output->verbose(
                                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> LR 0x%" PRI_ADDR " / thr: %" PRIu32 " / (LLSC_LOAD) %" PRIu16 " <- memory[ %" PRIu16 " ] / width: %" PRIu32 " / aq: %s / rl: %s\n",
            ...
            case 0x27:
            {
                // Floating point store
					 ...
					 output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> STORE-FP func_code3=%" PRIu32 " imm=%" PRId64 " / rs1: %" PRIu16 " / rs2: %" PRIu16 "\n",
						func_code3, simm64, rs1, rs2);

					switch(func_code3) {
					case 0x2:
						{
							output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> FSW imm=%" PRId64 " / rs1: %" PRIu16 " / rs2: %" PRIu16 "\n", simm64, rs1, rs2);
							bundle->addInstruction(new VanadisStoreInstruction(
					...
					case 0x3:
						{
							output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> FSD imm=%" PRId64 " / rs1: %" PRIu16 " / rs2: %" PRIu16 "\n", simm64, rs1, rs2);
							bundle->addInstruction(new VanadisStoreInstruction(
            ...
            case 0x53:
            {
                ...
                output->verbose(
                    CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> func_code3=%" PRIu32 " / func_code7=%" PRIu32 "\n", func_code3, func_code7);
                ...
                case 44:
                {
                    //FSQRT.S
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSQRT.S %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
                ...
                case 45:
                {
                    //FSQRT.D
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSQRT.D %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
                ...
                case 0:
                {
                    // FADD.S
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FADD.S %" PRIu16 " <- %" PRIu16 " + %" PRIu16 "\n", rd, rs1, rs2);
                ...
                case 0x1:
                {
                    // FADD.D
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FADD.D %" PRIu16 " <- %" PRIu16 " + %" PRIu16 "\n", rd, rs1, rs2);
                ...
                case 4:
                {
                    // FSUB.S
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSUB.S %" PRIu16 " <- %" PRIu16 " + %" PRIu16 "\n", rd, rs1, rs2);
                ...
                case 5:
                {
                    // FSUB.D
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSUB.D %" PRIu16 " <- %" PRIu16 " + %" PRIu16 "\n", rd, rs1, rs2);
                    ...
                    decode_fault = false;
					 ...
					 case 8:
					 {
							// FMUL.S
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMUL.S %" PRIu16 " <- %" PRIu16 " * %" PRIu16 "\n", rd, rs1, rs2);
                ...
                case 9:
                {
                    // FMUL.D
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMUL.D %" PRIu16 " <- %" PRIu16 " * %" PRIu16 "\n", rd, rs1, rs2);
                ...
                case 16:
                {
                    ...
                    {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSGNJ.S %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1,
                            rs2);
                    ...
                    {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSGNJN.S %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1,
                            rs2);
                    ...
                    {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSGNJX.S %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1,
                            rs2);
                ...
                case 17:
                {
                    ...
                    {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSGNJ.D %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1,
                            rs2);
                    ...
                    {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSGNJN.D %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1,
                            rs2);
                    ...
                    {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSGNJX.D %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1,
                            rs2);
					 ...
					 {
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> FDIV.S %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1, rs2);
                ...
                {
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> FDIV.D %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1, rs2);
                ...
                case 20:
                {
                    switch ( func_code3 ) { 
                        ...
                        {
                            output->verbose(
                                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> FMIN.S %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1, rs2);
                        ...
                        {
                            output->verbose(
                                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> FMAX.S %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1, rs2);
                ...
                case 21:
                {
                    switch ( func_code3 ) { 
                        ...
                        {
                            output->verbose(
                                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> FMIN.D %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1, rs2);
                        ...
                        {
                            output->verbose(
                                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> FMAX.D %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1, rs2);
					...
					case 32:
                    {
                      ...
                      output->verbose( CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> func_code3=%" PRIu32 " / func_code7=%" PRIu32 "\n", func_code3, func_code7);

                      switch ( rs2 ) {
                        case 1:
                        {
                            // double to float
                            output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.S.D %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                    ...
                    {
                        // float to double
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.D.S %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                ...
                case 104:
                {
                    ...
                    {
                        // int32 to float
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.S.W %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                    ...
                    {
                        // uint32 to float
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.S.WU %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                    ...
                    {
                        // int64 to float
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.S.L %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                    ...
                    {
                        // uint64 to float
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.S.LU %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                ...
                case 96:
                {
                    ...
                    {
                        // float to int32
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.W.S %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                    ...
                    {
                        // float to uint32
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.WU.S %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                    ...
                    {
                        // float to int64
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.L.S %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                ...
                case 97:
                {
                    ...
                    {
                        // double to int32
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.W.D %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                    ...
                    {
                        // double to uint32
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.WU.D %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                    ...
                    {
                        // double to int64
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.L.D %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                    ...
                    {
                        // double to uint64
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.LU.D %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                ...
                case 105:
                {
                    ...
                    {
                        // int32 to double
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.D.W %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                    ...
                    {
                        // uint32 to double
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.D.WU %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                    ...
                    {
                        // int64 to double
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.D.L %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                    ...
                    {
                        // uint64 to double
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.D.LU %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
				 ...
				 case 0x70:
				 {
                    ...
                    case 0:
                    {
						switch(func_code3) {
							case 0: {
								output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMV.X.W %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
                            ...
                            case 1:
                            {
								output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCLASS.S %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
				 ...
				 case 120:
				 {
                    ...
                    case 0:
                    {
								switch(func_code3) {
								case 0: {
							output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMV.W.X %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
                ...
                case 0x50:
                {
                    ...
                    case 0x0:
                    {
                        // FLE.S
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FLE.S %" PRIu16 " <- %" PRIu16 " <= %" PRIu16 "\n", rd, rs1, rs2);
                    ...
                    case 0x1:
                    {
                        // FLT.S
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FLT.S %" PRIu16 " <- %" PRIu16 " <= %" PRIu16 "\n", rd, rs1, rs2);
                    ...
                    case 0x2:
                    {
                        // FEQ.S
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FEQ.S %" PRIu16 " <- %" PRIu16 " < %" PRIu16 "\n", rd, rs1, rs2);
                ...
                case 0x51:
                {
                    ...
                    case 0x0:
                    {
                        // FLE.D
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FLE.D %" PRIu16 " <- %" PRIu16 " <= %" PRIu16 "\n", rd, rs1, rs2);
                    ...
                    case 0x1:
                    {
                        // FLT.D
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FLT.D %" PRIu16 " <- %" PRIu16 " < %" PRIu16 "\n", rd, rs1, rs2);
                    ...
                    case 0x2:
                    {
                        // FEQ.D
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FEQ.D %" PRIu16 " <- %" PRIu16 " < %" PRIu16 "\n", rd, rs1, rs2);
                ...
                case 0x71:
                {
                    ...
                    if ( 0 == rs2 ) {
                        ...
                        case 0:
                        {
                            output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMV.X.D %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
                        ...
                        case 1:
                        {
                            output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCLASS.D %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
                ...
                case 0x79:
                {
                    ...
                    if ( 0 == rs2 ) {
                        if ( 0 == func_code3 ) {
                            output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMV.D.X %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
            ...
            case 0x43:
            {
                ...
                switch( fmt ) {
                    case 0:
                    {
                        // FMADD.S
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMADD.S %" PRIu16 " <- ( %" PRIu16 " *  %" PRIu16 " ) + %" PRIu16 "\n", rd, rs1, rs2, rs3);
                    ...
                    case 1:
                    {
                        // FMADD.D
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMADD.D %" PRIu16 " <- ( %" PRIu16 " *  %" PRIu16 " ) + %" PRIu16 "\n", rd, rs1, rs2, rs3);
            ...
            case 0x47:
            {
                ...
                switch( fmt ) {
                    case 0:
                    {
                        // FMSUB.S
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMSUB.S %" PRIu16 " <- ( %" PRIu16 " *  %" PRIu16 " ) -  %" PRIu16 "\n", rd, rs1, rs2, rs3);
                    ...
                    case 1:
                    {
                        // FMSUB.D
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMSUB.D %" PRIu16 " <- ( %" PRIu16 " *  %" PRIu16 " ) -  %" PRIu16 "\n", rd, rs1, rs2, rs3);
            ...
            case 0x4B:
            {
                ...
                output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> fmt: %" PRIu32 " rs3: %" PRIu32 "\n", fmt, rs3);
                ...
                switch( fmt ) {
                    case 0:
                    {
                        // FNMSUB.S
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FNMSUB.S %" PRIu16 " <- ( - %" PRIu16 " *  %" PRIu16 " ) -  %" PRIu16 "\n", rd, rs1, rs2, rs3);
                    ...
                    case 1:
                    {
                        // FNMSUB.D
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FNMSUB.D %" PRIu16 " <- ( - %" PRIu16 " *  %" PRIu16 " ) -  %" PRIu16 "\n", rd, rs1, rs2, rs3);
            ...
            case 0x4F:
            {
                ...
                switch( fmt ) {
                    case 0:
                    {
                        // FNMADD.S
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FNMADD.S %" PRIu16 " <- ( - %" PRIu16 " *  %" PRIu16 " ) -  %" PRIu16 "\n", rd, rs1, rs2, rs3);
                    ...
                    case 1:
                    {
                        // FNMADD.D
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FNMADD.D %" PRIu16 " <- ( - %" PRIu16 " *  %" PRIu16 " ) -  %" PRIu16 "\n", rd, rs1, rs2, rs3);
            ...
            output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC op_code: %" PRIu32 "\n", c_op_code);
            ...
            case 0x0:
            {
                ...
                case 0x0:
                {
                    if ( (ins & 0xFFFF) == 0 ) {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> RVC ADDI4SPN %" PRIu16 " <- r2 (stack-ptr) + %" PRIu32 "\n",
                            rvc_rd, imm);
                ...
                case 0x2000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> RVC FLD %" PRIu16 " <- memory[ %" PRIu16 " + %" PRIu32 " ]\n",
                        rvc_rd, rvc_rs1, imm);
                ...
                case 0x4000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC LW rd=%" PRIu16 " <- rs1=%" PRIu16 " + imm=%" PRIu64 "\n", rvc_rd,
                        rvc_rs1, imm_address);
                ...
                case 0x6000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC LD rd=%" PRIu16 " <- rs1=%" PRIu16 " + imm=%" PRIu64 "\n", rvc_rd,
                        rvc_rs1, imm_address);
                ...
                case 0xA000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> RVC FSD %" PRIu16 " -> memory[ %" PRIu16 " + %" PRIu32 " ]\n",
                        rvc_rs2, rvc_rs1, imm);
                ...
                case 0xC000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC SW %" PRIu16 " -> %" PRIu16 " + %" PRIu64 "\n", rvc_rs2, rvc_rs1,
                        offset);
                ...
                case 0xE000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC SD %" PRIu16 " -> %" PRIu16 " + %" PRIu64 "\n", rvc_rs2, rvc_rs1,
                        offset);
            ...
            case 0x1:
            {
                ...
                case 0x0:
                {
                    ...
                    if ( 0 == rvc_rs1 ) {
                        // This is a no-op?
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> creates a no-op.\n");
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC ADDI %" PRIu16 " = %" PRIu16 " + %" PRId64 "\n", rvc_rs1,
                            rvc_rs1, imm);
                ...
                case 0x2000:
                {
                    ...
                    output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC ADDIW  reg: %" PRIu16 ", imm=%" PRId32 "\n", rd, imm);

                    // This really is a W-clipping instruction, so make INT32
                    
                    bundle->addInstruction(new VanadisAddImmInstruction<int32_t>(ins_address, hw_thr, options, rd, rd, static_cast<int32_t>(imm)));
                    decode_fault = false;
                } break;
                case 0x4000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC load imediate (LI) reg: %" PRIu16 ", imm=%" PRId64 "\n", rd, imm);
                ...
                case 0x6000:
                {
                    ...
                    if ( rd != 2 ) {
                        ...
                        // ADDI16SP
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> RVC ADDI16SP\n");
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC ADDI16SP r2 <- %" PRId64 "\n", imm);
                ...
                case 0x8000:
                {
                    ...
                    output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "------> RCV arith code: %" PRIu32 "\n", c_func2_code);
                    ...
                    case 0x0:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> RVC SRLI %" PRIu16 " = %" PRIu16 " >> %" PRIu64 " (0x%" PRI_ADDR ")\n",
                    ...
                    case 0x400:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> RVC SRAI %" PRIu16 " = %" PRIu16 " >> %" PRIu64 " (0x%" PRI_ADDR ")\n",
                            rvc_rs1, rvc_rs1, shift_by, shift_by);
                        bundle->addInstruction(
                            new VanadisShiftRightArithmeticImmInstruction<VanadisRegisterFormat::VANADIS_FORMAT_INT64>(
                                ins_address, hw_thr, options, rvc_rs1, rvc_rs1, shift_by));
                    ...
                    case 0x800:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> RVC ANDI %" PRIu16 " = %" PRIu16 " & %" PRIu64 " (0x%" PRI_ADDR ")\n",
                    ...
                    case 0xC00:
                    {
                        ...
                        case 0x0:
                        {
                            output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "------> RVC arith check zero family\n");
                            ...
                            case 0x0:
                            {
                                // SUB
                                output->verbose(
                                    CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> RVC SUB %" PRIu16 " <- %" PRIu16 " - %" PRIu16 "\n",
                            ...
                            case 0x20:
                            {
                                // XOR
                                output->verbose(
                                    CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> RVC XOR %" PRIu16 " <- %" PRIu16 " ^ %" PRIu16 "\n",
                                    rvc_rs1, rvc_rs1, rvc_rs2);
                                bundle->addInstruction(
                            ...
                            case 0x40:
                            {
                                // OR
                                output->verbose(
                                    CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> RVC OR %" PRIu16 " <- %" PRIu16 " | %" PRIu16 "\n",
                                    rvc_rs1, rvc_rs1, rvc_rs2);
                                bundle->addInstruction(
                            ...
                            case 0x60:
                            {
                                // AND
                                output->verbose(
                                    CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> RVC AND %" PRIu16 " <- %" PRIu16 " & %" PRIu16 "\n",
                                    rvc_rs1, rvc_rs1, rvc_rs2);
                        ...
                        case 0x1000:
                        {
                            output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "------> RVC arith check one family\n");
                            ...
                            case 0x0:
                            {
                                ...
                                output->verbose(
                                    CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "------> RVC SUBW %" PRIu16 " <- %" PRIu16 " + %" PRIu16 "\n",
                                    rvc_rs1, rvc_rs1, rvc_rs2);
                            ...
                            case 0x20:
                            {
                                ...
                                output->verbose(
                                    CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "------> RVC ADDW %" PRIu16 " <- %" PRIu16 " + %" PRIu16 " hw_thr=%d\n",
                ...
                case 0xA000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> decode RVC JUMP pc=0x%" PRI_ADDR " + imm=%" PRId64 " = 0x%" PRI_ADDR "\n", ins_address,
                ...
                case 0xC000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> decode RVC BEQZ %" PRIu16 " jump to: 0x%" PRI_ADDR " + 0x%" PRI_ADDR " = 0x%" PRI_ADDR "\n",
                ...
                case 0xE000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> decode RVC BNEZ %" PRIu16 " jump to: 0x%" PRI_ADDR " + 0x%" PRI_ADDR " = 0x%" PRI_ADDR "\n",
                        rvc_rs1, ins_address, imm_final, ins_address + imm_final);
            ...
            case 0x2:
            {
                ...
                output->verbose(
                    CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> RVC function code = %" PRIu32 " / 0x%" PRIx32 "\n", c_func_code, c_func_code);
                ...
                case 0x0:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> RVC SLLI %" PRIu16 " = %" PRIu16 " >> %" PRIu64 " (0x%" PRIx64 ")\n",
                        rvc_rs1, rvc_rs1, shift_by, shift_by);
                    bundle->addInstruction(
                        new VanadisShiftLeftLogicalImmInstruction<uint64_t>(
                            ins_address, hw_thr, options, rvc_rs1, rvc_rs1, shift_by));
                ...
                case 0x2000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> RVC FLDSP %" PRIu16 " <- memory[sp (r2) + %" PRIu32 "]\n", rvc_rd,
                        offset);
                    bundle->addInstruction(new VanadisLoadInstruction(
                ...
                case 0x4000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> RVC LWSP %" PRIu16 " <- memory[sp (r2) + %" PRIu32 "]\n", rvc_rd,
                        offset);
                ...
                case 0x6000:
                {
                    ...
                    if ( 0 == rvc_rd ) {
                        // FLWSP
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC FLWSP STOP\n");
                    }
                    else {
                        // LDSP
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC LDSP rd=%" PRIu16 " <- %d + %" PRId64 "\n", rvc_rd,
                            2, offset);
                ...
                case 0x8000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "------> RVC 12b: %" PRIu32 " / rs1=%" PRIu32 " / rs2=%" PRIu32 "\n",
                    ...
                    if ( c_func_12 == 0 ) {
                        if ( c_func_12_rs2 == 0 ) {
                            // JR unless rs1 = 0
                            output->verbose(
                                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> (generates) RVC JR %" PRIu32 "\n", c_func_12_rs1);
                            ...
                            if ( c_func_12_rs1 == 0 ) {
                                ...
                                output->verbose(
                                    CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> (generates) RVC MV %" PRIu32 " <- %" PRIu32 " hw_thr=%d\n",
                        ...
                        if ( c_func_12_rs2 == 0 ) {
                            ...
                            if ( c_func_12_rs1 == 0 ) {
                                // RVC ADD HINT - fault?
                                output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> (generates) RVC ADD HINT hw_thr=%d\n", hw_thr);
                                // bundle->addInstruction(
                                //     new VanadisAddInstruction<int64_t>(
                                ...
                                //         static_cast<uint16_t>(c_func_12_rs1), static_cast<uint16_t>(c_func_12_rs2)));
                                    ...
                                    bundle->addInstruction(
                                        new VanadisAddInstruction<int64_t>(
                                            ins_address, hw_thr, options, static_cast<uint16_t>(c_func_12_rs1), static_cast<uint16_t>(c_func_12_rs1), static_cast<uint16_t>(c_func_12_rs2)));
                                decode_fault = false;
                            }
                        }
                    }
                ...
                case 0xA000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC FSDSP %" PRIu16 " -> memory[ sp + %" PRIu32 " ]\n", rvc_src,
                        offset);
                    bundle->addInstruction(new VanadisStoreInstruction(
                ...
                case 0xC000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC SWSP %" PRIu16 " -> %" PRIu16 " + %" PRIu32 "\n", rvc_src, (uint16_t)2,
                        offset);
                ...
                case 0xE000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC SDSP %" PRIu16 " -> %" PRIu16 " + %" PRIu32 "\n", rvc_src, (uint16_t)2,
                        offset);
            ...
            output->verbose(
                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "[decode] -> 16bit RVC format / ins-op-code-family: %" PRIu32 " / 0x%x\n", op_code,
                op_code);
    ...
    void decode_simt(SST::Output* output, const uint64_t ins_address, const uint32_t ins, VanadisInstructionBundle* bundle)
    {
        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "[decode] -> addr: 0x%" PRI_ADDR " / ins: 0x%08x\n", ins_address, ins);
        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "[decode] -> ins-bytes: 0x%08x\n", ins);
        ...
        if ( (ins & 0x3) == 0x3 ) {
            ...
            case 0x3:
            {
                ...
                case 0:
                {
                    ...
                    bundle->addInstruction(new VanadisSIMTLoadInstruction(
                        ins_address, hw_thr, options, rs1, simm64, rd, 1, true, MEM_TRANSACTION_NONE,
                        LOAD_INT_REGISTER));
                    decode_fault = false;
                } break;
            ...
            case 0x23:
            {
                ...
                if ( func_code < 4 ) {
                    ...
                    bundle->addInstruction(new VanadisSIMTStoreInstruction(
                        ins_address, hw_thr, options, rs1, simm64, rs2, store_bytes, MEM_TRANSACTION_NONE,
                        STORE_INT_REGISTER));
                    decode_fault = false;
                }
            ...
            case 0x13:
            {
                ...
                case 0:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "------> ADDI %" PRIu16 " <- %" PRIu16 " + %" PRId64 "\n", rd, rs1, simm64);
                    bundle->addInstruction(new VanadisSIMTAddImmInstruction<int64_t>(ins_address, hw_thr, options, rd, rs1, simm64));
                    decode_fault = false;
                } break;
                case 1:
                {
                    ...
                    {
                        bundle->addInstruction(
                            new VanadisSIMTShiftLeftLogicalImmInstruction<uint64_t>(
                                ins_address, hw_thr, options, rd, rs1, shift_by));
                        decode_fault = false;
                    } break;
                    };
                ...
                case 4:
                {
                    // XORI
                    processI<int64_t>(ins, op_code, rd, rs1, func_code3, simm64);
                    bundle->addInstruction(new VanadisSIMTXorImmInstruction(ins_address, hw_thr, options, rd, rs1, simm64));
                    decode_fault = false;
                } break;
                case 5:
                {
                ...
                case 6:
                {
                    // ORI
                    processI<int64_t>(ins, op_code, rd, rs1, func_code3, simm64);
                    bundle->addInstruction(new VanadisSIMTOrImmInstruction(ins_address, hw_thr, options, rd, rs1, simm64));
                    decode_fault = false;
                } break;
                case 7:
                {
                    // ANDI
                    processI<int64_t>(ins, op_code, rd, rs1, func_code3, simm64);
                    bundle->addInstruction(new VanadisSIMTAndImmInstruction(ins_address, hw_thr, options, rd, rs1, simm64));
                    decode_fault = false;
                } break;
                };
            } break;
            case 0x33:
            {
                ...
                case 0:
                {
                    ...
                    case 0:
                    {
                        ...
                        bundle->addInstruction(
                            new VanadisSIMTAddInstruction<int64_t>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        ...
                        bundle->addInstruction(
                            new VanadisSIMTMultiplyInstruction<int64_t>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 0x20:
                    {
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> SUB %" PRIu16 " <- %" PRIu16 " - %" PRIu16 "\n", rd, rs1, rs2);
                        // SUB
                        bundle->addInstruction(new VanadisSIMTSubInstruction<int64_t>(
                            ins_address, hw_thr, options, rd, rs1, rs2, false));
                        decode_fault = false;
                    } break;
                    };
                ...
                case 1:
                {
                    ...
                    case 0:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> SLL %" PRIu16 " <- %" PRIu16 " << %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(
                            new VanadisSIMTShiftLeftLogicalInstruction<VanadisRegisterFormat::VANADIS_FORMAT_INT64>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        ...
                        bundle->addInstruction(
                            new VanadisSIMTMultiplyHighInstruction<int64_t,int64_t>( ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    };
                } break;
                case 2:
                {
                    ...
                    case 0:
                    {
                        ...
                        // SLT
                        bundle->addInstruction(
                            new VanadisSIMTSetRegCompareInstruction<
                                VanadisRegisterCompareType::REG_COMPARE_LT, int64_t>(ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        ...
                        bundle->addInstruction(
                            new VanadisSIMTMultiplyHighInstruction<int64_t,uint64_t>( ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    };
                } break;
                case 3:
                {
                    ...
                    case 0x1:
                    {
                        ...
                        bundle->addInstruction(
                            new VanadisSIMTMultiplyHighInstruction<uint64_t,uint64_t>( ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    };
                } break;
                case 4:
                {
                    ...
                    case 0x0:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> XOR %" PRIu16 " <-  %" PRIu16 " ^ %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(new VanadisSIMTXorInstruction(ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        ...
                        bundle->addInstruction(
                            new VanadisSIMTDivideInstruction<int64_t>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    };
                ...
                case 5:
                {
                    ...
                    case 0:
                    {
                        ...
                        output->verbose(
                            ...
                            rs2);
                        bundle->addInstruction(
                            new VanadisSIMTShiftRightLogicalInstruction<VanadisRegisterFormat::VANADIS_FORMAT_INT64>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        ...
                        output->verbose(
                            ...
                            rs2);
                        bundle->addInstruction(
                            new VanadisSIMTDivideInstruction<uint64_t>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                    ...
                    case 32:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> SRA %" PRIu16 " <- %" PRIu16 " >> %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(
                            new VanadisSIMTShiftRightArithmeticInstruction<VanadisRegisterFormat::VANADIS_FORMAT_INT64>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    };
                ...
                case 6:
                {
                    ...
                    case 0x0:
                    {
                        ...
                        bundle->addInstruction(new VanadisSIMTOrInstruction(ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 0x1:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> REM %" PRIu16 " <- %" PRIu16 " %% %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(
                            new VanadisSIMTModuloInstruction<int64_t>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    }
                ...
                case 7:
                {
                    ...
                    case 0x0:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> AND %" PRIu16 " <- %" PRIu16 " & %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(new VanadisSIMTAndInstruction(ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 0x1:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> REMU %" PRIu16 " <- %" PRIu16 " %% %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(
                            new VanadisSIMTModuloInstruction<uint64_t>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    }
            ...
            case 0x37:
            {
                ...
                bundle->addInstruction(new VanadisSIMTSetRegisterInstruction<int32_t>(
                    ins_address, hw_thr, options, rd, uimm32));
                decode_fault = false;
            } break;
            case 0x17:
            {
                ...
                bundle->addInstruction(new VanadisSIMTPCAddImmInstruction<int64_t>(
                    ins_address, hw_thr, options, rd, simm64));
                decode_fault = false;
            } break;
            ...
            case 0x1B:
            {
                ...
                case 0x0:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> ADDIW %" PRIu16 " <- %" PRIu16 " + %" PRId64 "\n", rd, rs1,
                        addiw_imm);
                    bundle->addInstruction(new VanadisSIMTAddImmInstruction<int32_t>(ins_address, hw_thr, options, rd, rs1, static_cast<int32_t>(addiw_imm)));
                    decode_fault = false;
                } break;
                case 0x1:
                {
                    ...
                    case 0x0:
                    {
                        ...
                        output->verbose(
                            ...
                            rs1, rs2, rs2);
                        bundle->addInstruction(
                            new VanadisSIMTShiftLeftLogicalImmInstruction<uint32_t>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    }
            ...
            case 0x6F:
            {
                ...
                output->verbose(
                    ...
                    "-----> JAL link-reg: %" PRIu16 " / jump-address: 0x%" PRI_ADDR " + %" PRId64 " = 0x%" PRI_ADDR "\n", rd, ins_address,
                    simm64, jump_to);
                    bundle->addInstruction(new VanadisSIMTJumpLinkInstruction(
                        ins_address, hw_thr, options, 4, rd, jump_to, VANADIS_NO_DELAY_SLOT));
                decode_fault = false;
            } break;
            case 0x67:
            {
                ...
                {
                    // TODO - may need to zero bit 1 with an AND microop?
                    bundle->addInstruction(new VanadisSIMTJumpRegLinkInstruction(
                        ins_address, hw_thr, options, 4, rd, rs1, simm64, VANADIS_NO_DELAY_SLOT));
                    decode_fault = false;
                } break;
                };
            ...
            case 0x63:
            {
                ...
                case 0:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> BEQ %" PRIu16 " == %" PRIu16 " / offset: %" PRId64 "\n", rs1, rs2,
                        simm64);
                    bundle->addInstruction(new VanadisSIMTBranchRegCompareInstruction<int64_t, REG_COMPARE_EQ>(
                        ins_address, hw_thr, options, 4, rs1, rs2, simm64, VANADIS_NO_DELAY_SLOT));
                    decode_fault = false;
                } break;
                case 1:
                {
                    ...
                    output->verbose(
                        ...
                        "-----> BNE %" PRIu16 " != %" PRIu16 " / offset: %" PRId64 " (ip+offset %" PRIu64 ")\n", rs1,
                        rs2, simm64, ins_address + simm64);
                    bundle->addInstruction(new VanadisSIMTBranchRegCompareInstruction<int64_t, REG_COMPARE_NEQ>(
                        ins_address, hw_thr, options, 4, rs1, rs2, simm64, VANADIS_NO_DELAY_SLOT));
                    decode_fault = false;
                } break;
                case 4:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> BLT %" PRIu16 " < %" PRIu16 " / offset: %" PRId64 "\n", rs1, rs2,
                        simm64);
                    bundle->addInstruction(new VanadisSIMTBranchRegCompareInstruction<int64_t, REG_COMPARE_LT>(
                        ins_address, hw_thr, options, 4, rs1, rs2, simm64, VANADIS_NO_DELAY_SLOT));
                    decode_fault = false;
                } break;
                case 5:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> BGE %" PRIu16 " >= %" PRIu16 " / offset: %" PRId64 "\n", rs1, rs2,
                        simm64);
                    bundle->addInstruction(new VanadisSIMTBranchRegCompareInstruction<int64_t, REG_COMPARE_GTE>(
                        ins_address, hw_thr, options, 4, rs1, rs2, simm64, VANADIS_NO_DELAY_SLOT));
                    decode_fault = false;
                } break;
                case 6:
                {
                    // BLTU
                    bundle->addInstruction(new VanadisSIMTBranchRegCompareInstruction<uint64_t, REG_COMPARE_LT>(
                        ins_address, hw_thr, options, 4, rs1, rs2, simm64, VANADIS_NO_DELAY_SLOT));
                    decode_fault = false;
                } break;
                case 7:
                {
                    // BGEU
                    bundle->addInstruction(new VanadisSIMTBranchRegCompareInstruction<uint64_t, REG_COMPARE_GTE>(
                        ins_address, hw_thr, options, 4, rs1, rs2, simm64, VANADIS_NO_DELAY_SLOT));
                    decode_fault = false;
                } break;
                };
            ...
            case 0x73:
            {
                ...
                if ( (0 == rd) && (0 == rs1) && (0 == func_code) ) {
                    ...
                    {
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "------> ECALL/SYSCALL\n");
                        bundle->addInstruction(new VanadisSIMTFenceInstruction(ins_address, hw_thr, options, VANADIS_LOAD_STORE_FENCE));
                        bundle->addInstruction(new VanadisSIMTSysCallInstruction(ins_address, hw_thr, options));
                        decode_fault = false;
                    } break;
                    case 0x1: // SBREAK
                    {
                    ...
                    switch ( uimm64 ) 
                    {
                        case 0x1: // FSFLAGS
                        {
                            ...
                            if ( ! ( ( 0x1 == func_code || 0x3 == func_code ) && 0 == rd ) ) {
                                bundle->addInstruction(new VanadisSIMTFPFlagsReadInstruction<false, false, true>(ins_address, hw_thr, options, fpflags, rd));
                                }
                            if ( ! ( 0x2 == func_code && rs1 == 0 ) ) {
                                if ( func_code & 0x4 ) {
                                    bundle->addInstruction(
                                       new VanadisSIMTFPFlagsSetImmInstruction<false,true>(ins_address, hw_thr, options, fpflags, static_cast<uint64_t>(rs1), func_code & 0x3));
                                } else {
                                    bundle->addInstruction(
                                        new VanadisSIMTFPFlagsSetInstruction<false,true>(ins_address, hw_thr, options, fpflags, rs1, func_code & 0x3 ));
                                    }
                            }
                            decode_fault = false;
                        } break;
                        case 0x2: // FSRM
                        {
                            ...
                            if ( ! ( ( 0x1 == func_code || 0x3 == func_code ) && 0 == rd ) ) {
                                bundle->addInstruction(new VanadisSIMTFPFlagsReadInstruction<true, false, false>(ins_address, hw_thr, options, fpflags, rd));
                                }
                            if ( ! ( 0x2 == func_code && rs1 == 0 ) ) {
                                 if ( func_code & 0x4 ) {
                                    bundle->addInstruction(
                                        new VanadisSIMTFPFlagsSetImmInstruction<true,false>(ins_address, hw_thr, options, fpflags, static_cast<uint64_t>(rs1), func_code & 0x3));
                                } else {
                                    bundle->addInstruction(
                                        new VanadisSIMTFPFlagsSetInstruction<true,false>(ins_address, hw_thr, options, fpflags, rs1, func_code & 0x3 ));
                                    }
                            }
                            decode_fault = false;
                        } break;
                        case 0x3: // FCSR
                        {
                            ...
                            if ( ! ( ( 0x1 == func_code || 0x3 == func_code ) && 0 == rd ) ) {
                                bundle->addInstruction(new VanadisSIMTFPFlagsReadInstruction<true, true, true>(ins_address, hw_thr, options, fpflags, rd));
                                } 
                            if ( ! ( 0x2 == func_code && rs1 == 0 ) ) {
                                if ( func_code & 0x4 ) {
                                    bundle->addInstruction(
                                        new VanadisSIMTFPFlagsSetImmInstruction<true,true>(ins_address, hw_thr, options, fpflags, static_cast<uint64_t>(rs1), func_code & 0x3));
                                } else {
                                    bundle->addInstruction(
                                        new VanadisSIMTFPFlagsSetInstruction<true,true>(ins_address, hw_thr, options, fpflags, rs1, func_code & 0x3 ));
                                    }
                            }
                            decode_fault = false;
                      } break;
                      default:
                      {
                        ...
                        switch ( csrNum ) {
                            case 0xc00:
                            {
                                if ( 0 == rs1 ) {
                                    auto thread_call = std::bind(&VanadisRISCV64Decoder::getCycleCount, this);
                                    bundle->addInstruction( new VanadisSIMTSetRegisterByCallInstruction<int64_t>( ins_address, hw_thr, options, rd, thread_call));
                                    decode_fault = false;
                                }
                            } break;
                        }
            ...
            case 0x3B:
            {
                ...
                case 0:
                {
                    ...
                    case 0x1:
                    {
                        ...
                        // TODO - check register ordering
                        bundle->addInstruction(
                            new VanadisSIMTMultiplyInstruction<int32_t>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 0x20:
                    {
                        // SUBW
                        // TODO - check register ordering
                        bundle->addInstruction(new VanadisSIMTSubInstruction<int32_t>(
                            ins_address, hw_thr, options, rd, rs1, rs2, true));
                        decode_fault = false;
                    } break;
                    };
                ...
                case 1:
                {
                    ...
                    case 0x0:
                    {
                        ...
                        // TODO - check register ordering
                        bundle->addInstruction(
                            new VanadisSIMTShiftLeftLogicalInstruction<VanadisRegisterFormat::VANADIS_FORMAT_INT32>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    };
                ...
                case 4:
                {
                    ...
                    case 0x1:
                    {
                        // DIVW
                        bundle->addInstruction(
                            new VanadisSIMTDivideInstruction<int32_t>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    };
                ...
                case 5:
                {
                    ...
                    case 0x0:
                    {
                        ...
                        // TODO - check register ordering
                        bundle->addInstruction(
                            new VanadisSIMTShiftRightLogicalInstruction<VanadisRegisterFormat::VANADIS_FORMAT_INT32>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 0x1:
                    {
                        // DIVUW
                        bundle->addInstruction(
                            new VanadisSIMTDivideInstruction<uint32_t>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 0x20:
                    {
                        ...
                        // TODO - check register ordering
                        bundle->addInstruction(
                            new VanadisSIMTShiftRightArithmeticInstruction<VanadisRegisterFormat::VANADIS_FORMAT_INT32>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    };
                ...
                case 6:
                {
                    ...
                    case 0x1:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> REMW %" PRIu16 " <- %" PRIu16 " %% %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(
                            new VanadisSIMTModuloInstruction<int32_t>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    };
                ...
                case 7:
                {
                    ...
                    case 0x1:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> REMUW %" PRIu16 " <- %" PRIu16 " %% %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(
                            new VanadisSIMTModuloInstruction<uint32_t>(
                                ins_address, hw_thr, options, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    }
            ...
            case 0x2F:
            {
                ...
                case AMO_SWAP:
                {
                    if(LIKELY(op_width != 0)) {
                        ...
                        // 0 is a success, 1 is a failure
                        bundle->addInstruction(new VanadisSIMTStoreConditionalInstruction(
                                ins_address, hw_thr, options, rs1, 0, rs2, /* place in r33 */ 33, op_width,
                                STORE_INT_REGISTER, 0, 1));

                        // conditionally copy the loaded value into rd IF the store-conditional was successful
                        // copy r32 into rd if r33 == 0
                        bundle->addInstruction(new VanadisSIMTConditionalMoveImmInstruction<int64_t, int64_t, REG_COMPARE_EQ>(
                                ins_address, hw_thr, options, rd, 34, 33, 0
                        ));
                        bundle->addInstruction(new VanadisSIMTBranchRegCompareImmInstruction<int64_t, REG_COMPARE_EQ>(
                            ins_address, hw_thr, options, 4, 33, 1,
                            /* offset is 0 so we replay this instruction */ 0, VANADIS_NO_DELAY_SLOT
                        ));
                        if(LIKELY(perform_rl)) {
                ...
                case AMO_MAXU:
                {
                    if(LIKELY(op_width != 0)) {
                        ...
                        case AMO_ADD:
                            ...
                            break;
                        case AMO_XOR:
                            bundle->addInstruction( new VanadisSIMTXorInstruction( ins_address, hw_thr, options, 32, 34, rs2)); 
                            break;
                        case AMO_OR:
                            bundle->addInstruction( new VanadisSIMTOrInstruction( ins_address, hw_thr, options, 32, 34, rs2)); 
                            break;
                        case AMO_AND:
                            bundle->addInstruction( new VanadisSIMTAndInstruction( ins_address, hw_thr, options, 32, 34, rs2));
                            break;
                        case AMO_MIN:
                            if ( AMO_W == func_code3 ) {
                                bundle->addInstruction( new VanadisSIMTMinInstruction<int32_t,true>( ins_address, hw_thr, options, 32, 34, rs2));
                            } else {
                                bundle->addInstruction( new VanadisSIMTMinInstruction<int64_t,true>( ins_address, hw_thr, options, 32, 34, rs2));
                            }
                            break;
                        case AMO_MAX:
                            if ( AMO_W == func_code3 ) {
                                bundle->addInstruction( new VanadisSIMTMinInstruction<int32_t,false>( ins_address, hw_thr, options, 32, 34, rs2));
                            } else {
                                bundle->addInstruction( new VanadisSIMTMinInstruction<int64_t,false>( ins_address, hw_thr, options, 32, 34, rs2));
                            }
                            break;
                        case AMO_MINU:
                            if ( AMO_W == func_code3 ) {
                                bundle->addInstruction( new VanadisSIMTMinInstruction<uint32_t,true>( ins_address, hw_thr, options, 32, 34, rs2));
                            } else {
                                bundle->addInstruction( new VanadisSIMTMinInstruction<uint64_t,true>( ins_address, hw_thr, options, 32, 34, rs2));
                            }
                            break;
                        case AMO_MAXU:
                            if ( AMO_W == func_code3 ) {
                                bundle->addInstruction( new VanadisSIMTMinInstruction<uint32_t,false>( ins_address, hw_thr, options, 32, 34, rs2));
                            } else {
                                bundle->addInstruction( new VanadisSIMTMinInstruction<uint64_t,false>( ins_address, hw_thr, options, 32, 34, rs2));
                            }
                            break;
                        default: assert(0);
                        }
            ...
            case 0x53:
            {
                ...
                case 44:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSQRT.S %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
                    bundle->addInstruction(
                        new VanadisSIMTFPSquareRootInstruction<float>(ins_address, hw_thr, options, fpflags, rd, rs1));
                    decode_fault = false;
                } break;
                case 45:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSQRT.D %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
                    bundle->addInstruction(
                        new VanadisSIMTFPSquareRootInstruction<double>(ins_address, hw_thr, options, fpflags, rd, rs1));
                    decode_fault = false;
                } break;
                case 0:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FADD.S %" PRIu16 " <- %" PRIu16 " + %" PRIu16 "\n", rd, rs1, rs2);
                    bundle->addInstruction(
                        new VanadisSIMTFPAddInstruction<float>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                    decode_fault = false;
                } break;
                case 0x1:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FADD.D %" PRIu16 " <- %" PRIu16 " + %" PRIu16 "\n", rd, rs1, rs2);
                    bundle->addInstruction(
                        new VanadisSIMTFPAddInstruction<double>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                    decode_fault = false;
                } break;
                case 4:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSUB.S %" PRIu16 " <- %" PRIu16 " + %" PRIu16 "\n", rd, rs1, rs2);
                    bundle->addInstruction(
                        new VanadisSIMTFPSubInstruction<float>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                    decode_fault = false;
                } break;
                case 5:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FSUB.D %" PRIu16 " <- %" PRIu16 " + %" PRIu16 "\n", rd, rs1, rs2);
                    bundle->addInstruction(
                        new VanadisSIMTFPSubInstruction<double>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                    decode_fault = false;
                } break;
					 case 8:
					 {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMUL.S %" PRIu16 " <- %" PRIu16 " * %" PRIu16 "\n", rd, rs1, rs2);
                    bundle->addInstruction(
                        new VanadisSIMTFPMultiplyInstruction<float>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                    decode_fault = false;
					 } break;
                case 9:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMUL.D %" PRIu16 " <- %" PRIu16 " * %" PRIu16 "\n", rd, rs1, rs2);
                    bundle->addInstruction(
                        new VanadisSIMTFPMultiplyInstruction<double>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                    decode_fault = false;
                } break;
                case 16:
                {
                    ...
                    case 0:
                    {
                        output->verbose(
                            ...
                            rs2);
                        bundle->addInstruction(
                            new VanadisSIMTFPSignLogicInstruction<float, VanadisFPSignLogicOperation::SIGN_COPY>(
                                ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        output->verbose(
                            ...
                            rs2);
                        bundle->addInstruction(
                            new VanadisSIMTFPSignLogicInstruction<float, VanadisFPSignLogicOperation::SIGN_NEG>(
                                ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 2:
                    {
                        output->verbose(
                            ...
                            rs2);
                        bundle->addInstruction(
                            new VanadisSIMTFPSignLogicInstruction<float, VanadisFPSignLogicOperation::SIGN_XOR>(
                                ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    }
                ...
                case 17:
                {
                    ...
                    case 0:
                    {
                        output->verbose(
                            ...
                            rs2);
                        bundle->addInstruction(
                            new VanadisSIMTFPSignLogicInstruction<double, VanadisFPSignLogicOperation::SIGN_COPY>(
                                ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        output->verbose(
                            ...
                            rs2);
                        bundle->addInstruction(
                            new VanadisSIMTFPSignLogicInstruction<double, VanadisFPSignLogicOperation::SIGN_NEG>(
                                ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 2:
                    {
                        output->verbose(
                            ...
                            rs2);
                        bundle->addInstruction(
                            new VanadisSIMTFPSignLogicInstruction<double, VanadisFPSignLogicOperation::SIGN_XOR>(
                                ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    }
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> FDIV.S %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1, rs2);
                    bundle->addInstruction(new VanadisSIMTFPDivideInstruction<float>(
                        ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                    decode_fault = false;
					 } break;
                case 0xD:
                {
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> FDIV.D %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1, rs2);
                    bundle->addInstruction(new VanadisSIMTFPDivideInstruction<double>(
                        ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                    decode_fault = false;
                } break;
                case 20:
                {
                    switch ( func_code3 ) { 
                        case 0:
                        {
                            output->verbose(
                                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> FMIN.S %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1, rs2);
                            bundle->addInstruction(new VanadisSIMTFPMinimumInstruction<float,true>(
                                ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                            decode_fault = false;
                        } break;
                        case 1:
                        {
                            output->verbose(
                                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> FMAX.S %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1, rs2);
                            bundle->addInstruction(new VanadisSIMTFPMinimumInstruction<float,false>(
                                ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                            decode_fault = false;
                        } break;
                    }
                ...
                case 21:
                {
                    switch ( func_code3 ) { 
                        case 0:
                        {
                            output->verbose(
                                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> FMIN.D %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1, rs2);
                            bundle->addInstruction(new VanadisSIMTFPMinimumInstruction<double,true>(
                                ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                            decode_fault = false;
                        } break;
                        case 1:
                        {
                            output->verbose(
                                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "---> FMAX.D %" PRIu16 " <- %" PRIu16 " / %" PRIu16 "\n", rd, rs1, rs2);
                            bundle->addInstruction(new VanadisSIMTFPMinimumInstruction<double,false>(
                                ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                            decode_fault = false;
                        } break;
                    }
					...
					case 32:
                    {
                      ...
                      switch ( rs2 ) {
                        case 1:
                        {
                            ...
                            output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.S.D %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                            bundle->addInstruction(
                                new VanadisSIMTFPConvertInstruction<double,float>(ins_address, hw_thr, options, fpflags, rd, rs1));
                            decode_fault = false;
                        } break;
                      }
                    } break;
                    ...
                    case 0:
                    {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.D.S %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                        bundle->addInstruction(
                                new VanadisSIMTFPConvertInstruction<float, double>(ins_address, hw_thr, options, fpflags, rd, rs1));
                ...
                case 104:
                {
                    ...
                    case 0:
                    {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.S.W %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                        bundle->addInstruction(
                            new VanadisSIMTGPR2FPInstruction<int32_t, float, false>(ins_address, hw_thr, options, fpflags, rd, rs1));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.S.WU %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                        bundle->addInstruction(
                            new VanadisSIMTGPR2FPInstruction<uint32_t, float, false>(ins_address, hw_thr, options, fpflags, rd, rs1));
                        decode_fault = false;
                    } break;
                    case 2:
                    {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.S.L %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                        bundle->addInstruction(
                            new VanadisSIMTGPR2FPInstruction<int64_t, float, false>(ins_address, hw_thr, options, fpflags, rd, rs1));
                        decode_fault = false;
                    } break;
                    case 3:
                    {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.S.LU %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                        bundle->addInstruction(
                            new VanadisSIMTGPR2FPInstruction<uint64_t, float, false>(ins_address, hw_thr, options, fpflags, rd, rs1));
                        decode_fault = false;
                    } break;
                    }
                } break;
                case 96:
                {
                    ...
                    case 0:
                    {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.W.S %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                        bundle->addInstruction(
                            new VanadisSIMTFP2GPRInstruction<float, int32_t, false>(ins_address, hw_thr, options, fpflags, rd, rs1));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.WU.S %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                        bundle->addInstruction(
                            new VanadisSIMTFP2GPRInstruction<float, uint32_t, false>(ins_address, hw_thr, options, fpflags, rd, rs1));
                        decode_fault = false;
                    } break;
                    case 2:
                    {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.L.S %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                        bundle->addInstruction(
                            new VanadisSIMTFP2GPRInstruction<float, int64_t, false>(ins_address, hw_thr, options, fpflags, rd, rs1));
                        decode_fault = false;
                    } break;
                    case 3:
                    {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.L.S %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                        bundle->addInstruction(
                            new VanadisSIMTFP2GPRInstruction<float, uint64_t, false>(ins_address, hw_thr, options, fpflags, rd, rs1));
                        decode_fault = false;
                    } break;
                    }
                } break;
                ...
                case 105:
                {
                    ...
                    case 0:
                    {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.D.W %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                        bundle->addInstruction(
                            new VanadisSIMTGPR2FPInstruction<int32_t, double, false>(ins_address, hw_thr, options, fpflags, rd, rs1));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.D.WU %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                        bundle->addInstruction(
                            new VanadisSIMTGPR2FPInstruction<uint32_t, double, false>(ins_address, hw_thr, options, fpflags, rd, rs1));
                        decode_fault = false;
                    } break;
                    case 2:
                    {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.D.L %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                        bundle->addInstruction(
                            new VanadisSIMTGPR2FPInstruction<int64_t, double, false>(ins_address, hw_thr, options, fpflags, rd, rs1));
                        decode_fault = false;
                    } break;
                    case 3:
                    {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCVT.D.LU %" PRIu16 " <- %" PRIu16 "\n", rs1, rd);
                        bundle->addInstruction(
                            new VanadisSIMTGPR2FPInstruction<uint64_t, double, false>(ins_address, hw_thr, options, fpflags, rd, rs1));
                        decode_fault = false;
                    } break;
                    }
                } break;
                    ...
                    case 0:
                    {
						switch(func_code3) {
                            ...
                            case 1:
                            {
								output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCLASS.S %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
                                bundle->addInstruction(
                                new VanadisSIMTFPClassInstruction<uint64_t,float>(ins_address, hw_thr, options, fpflags, rd, rs1));
                                decode_fault = false;
                            } break;
						}
                    } break;
				 ...
				 case 120:
				 {
                    ...
                    case 0:
                    {
							...
							output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMV.W.X %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
                         bundle->addInstruction(
                            new VanadisSIMTGPR2FPInstruction<uint32_t, uint32_t, true>(ins_address, hw_thr, options, fpflags, rd, rs1));
                        decode_fault = false;
								} break;
								}
                    } break;
                ...
                case 0x50:
                {
                    ...
                    case 0x0:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FLE.S %" PRIu16 " <- %" PRIu16 " <= %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(new VanadisSIMTFPSetRegCompareInstruction<REG_COMPARE_LTE, float>(
                            ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 0x1:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FLT.S %" PRIu16 " <- %" PRIu16 " <= %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(new VanadisSIMTFPSetRegCompareInstruction<REG_COMPARE_LT, float>(
                            ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 0x2:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FEQ.S %" PRIu16 " <- %" PRIu16 " < %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(new VanadisSIMTFPSetRegCompareInstruction<REG_COMPARE_EQ, float>(
                            ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    }
                ...
                case 0x51:
                {
                    ...
                    case 0x0:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FLE.D %" PRIu16 " <- %" PRIu16 " <= %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(new VanadisSIMTFPSetRegCompareInstruction<REG_COMPARE_LTE, double>(
                            ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 0x1:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FLT.D %" PRIu16 " <- %" PRIu16 " < %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(new VanadisSIMTFPSetRegCompareInstruction<REG_COMPARE_LT, double>(
                            ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    case 0x2:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FEQ.D %" PRIu16 " <- %" PRIu16 " < %" PRIu16 "\n", rd, rs1, rs2);
                        bundle->addInstruction(new VanadisSIMTFPSetRegCompareInstruction<REG_COMPARE_EQ, double>(
                            ins_address, hw_thr, options, fpflags, rd, rs1, rs2));
                        decode_fault = false;
                    } break;
                    }
                ...
                case 0x71:
                {
                    ...
                    if ( 0 == rs2 ) {
                        ...
                        case 0:
                        {
                            output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMV.X.D %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
                            bundle->addInstruction(
                                new VanadisSIMTFP2GPRInstruction<uint64_t, uint64_t, false>(ins_address, hw_thr, options, fpflags, rd, rs1));
                            decode_fault = false;
                        } break;
                        case 1:
                        {
                            output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FCLASS.D %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
                                bundle->addInstruction(
                                new VanadisSIMTFPClassInstruction<uint64_t,double>(ins_address, hw_thr, options, fpflags, rd, rs1));
                            decode_fault = false;
                        } break;
                        }
                    }
                ...
                case 0x79:
                {
                    ...
                    if ( 0 == rs2 ) {
                        if ( 0 == func_code3 ) {
                            output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMV.D.X %" PRIu16 " <- %" PRIu16 "\n", rd, rs1);
                            bundle->addInstruction(
                                new VanadisSIMTGPR2FPInstruction<uint64_t, uint64_t, true>(ins_address, hw_thr, options, fpflags, rd, rs1));
                            decode_fault = false;
                        }
                    }
                } break;
                ...
                switch( fmt ) {
                    case 0:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMADD.S %" PRIu16 " <- ( %" PRIu16 " *  %" PRIu16 " ) + %" PRIu16 "\n", rd, rs1, rs2, rs3);
                        bundle->addInstruction(
                            new VanadisSIMTFPFusedMultiplyAddInstruction<float,false>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2, rs3 ));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMADD.D %" PRIu16 " <- ( %" PRIu16 " *  %" PRIu16 " ) + %" PRIu16 "\n", rd, rs1, rs2, rs3);
                        bundle->addInstruction(
                            new VanadisSIMTFPFusedMultiplyAddInstruction<double,false>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2, rs3 ));
                        decode_fault = false;
                    } break;
                }
            } break;
                ...
                switch( fmt ) {
                    case 0:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMSUB.S %" PRIu16 " <- ( %" PRIu16 " *  %" PRIu16 " ) -  %" PRIu16 "\n", rd, rs1, rs2, rs3);
                        bundle->addInstruction(
                            new VanadisSIMTFPFusedMultiplySubInstruction<float,false>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2, rs3 ));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FMSUB.D %" PRIu16 " <- ( %" PRIu16 " *  %" PRIu16 " ) -  %" PRIu16 "\n", rd, rs1, rs2, rs3);
                        bundle->addInstruction(
                            new VanadisSIMTFPFusedMultiplySubInstruction<double,false>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2, rs3 ));
                        decode_fault = false;
                    } break;
                }
            } break;
                ...
                switch( fmt ) {
                    case 0:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FNMSUB.S %" PRIu16 " <- ( - %" PRIu16 " *  %" PRIu16 " ) -  %" PRIu16 "\n", rd, rs1, rs2, rs3);
                        bundle->addInstruction(
                            new VanadisSIMTFPFusedMultiplySubInstruction<float,true>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2, rs3 ));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FNMSUB.D %" PRIu16 " <- ( - %" PRIu16 " *  %" PRIu16 " ) -  %" PRIu16 "\n", rd, rs1, rs2, rs3);
                        bundle->addInstruction(
                            new VanadisSIMTFPFusedMultiplySubInstruction<double,true>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2, rs3 ));
                        decode_fault = false;
                    } break;
                }
            } break;
                ...
                switch( fmt ) {
                    case 0:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FNMADD.S %" PRIu16 " <- ( - %" PRIu16 " *  %" PRIu16 " ) -  %" PRIu16 "\n", rd, rs1, rs2, rs3);
                        bundle->addInstruction(
                            new VanadisSIMTFPFusedMultiplyAddInstruction<float,true>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2, rs3 ));
                        decode_fault = false;
                    } break;
                    case 1:
                    {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> FNMADD.D %" PRIu16 " <- ( - %" PRIu16 " *  %" PRIu16 " ) -  %" PRIu16 "\n", rd, rs1, rs2, rs3);
                        bundle->addInstruction(
                            new VanadisSIMTFPFusedMultiplyAddInstruction<double, true>(ins_address, hw_thr, options, fpflags, rd, rs1, rs2, rs3 ));
                        decode_fault = false;
                    } break;
                }
            } break;
                ...
                case 0x0:
                {
                    if ( (ins & 0xFFFF) == 0 ) {
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-------> RVC ADDI4SPN %" PRIu16 " <- r2 (stack-ptr) + %" PRIu32 "\n",
                            rvc_rd, imm);
                            bundle->addInstruction(new VanadisSIMTAddImmInstruction<int64_t>(ins_address, hw_thr, options, rvc_rd, 2, imm));
                        decode_fault = false;
                    }
                } break;
                case 0x2000:
            ...
            case 0x1:
            {
                ...
                case 0x0:
                {
                    ...
                    if ( 0 == rvc_rs1 ) {
                        // This is a no-op?
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> creates a no-op.\n");
                        bundle->addInstruction(new VanadisSIMTAddImmInstruction<int64_t>(ins_address, hw_thr, options, 0, 0, 0));
                        decode_fault = false;
                    }
                    else {
                        uint32_t imm_40 = (ins & 0x7C) >> 2;
                        ...
                        output->verbose(
                            CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC ADDI %" PRIu16 " = %" PRIu16 " + %" PRId64 "\n", rvc_rs1,
                            rvc_rs1, imm);
                        bundle->addInstruction(new VanadisSIMTAddImmInstruction<int64_t>(
                            ins_address, hw_thr, options, rvc_rs1, rvc_rs1, imm));
                        decode_fault = false;
                    }
                } break;
                case 0x2000:
                {
                    ...
                    // This really is a W-clipping instruction, so make INT32
                    bundle->addInstruction(new VanadisSIMTAddImmInstruction<int32_t>(ins_address, hw_thr, options, rd, rd, static_cast<int32_t>(imm)));
                    decode_fault = false;
                } break;
                case 0x4000:
                {
                    ...
                    bundle->addInstruction(
                        new VanadisSIMTSetRegisterInstruction<int64_t>(
                            ins_address, hw_thr, options, rd, imm));
                    decode_fault = false;
                } break;
                case 0x6000:
                {
                    ...
                    if ( rd != 2 ) {
                        ...
                        bundle->addInstruction(
                            new VanadisSIMTSetRegisterInstruction<int32_t>(
                                ins_address, hw_thr, options, rd, imm));
                        decode_fault = false;
                    }
                    else {
                        ...
                        output->verbose(CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "-----> RVC ADDI16SP r2 <- %" PRId64 "\n", imm);
                        bundle->addInstruction(new VanadisSIMTAddImmInstruction<int64_t>(ins_address, hw_thr, options, 2, 2, imm));
                        decode_fault = false;
                    }
                } break;
                case 0x8000:
                {
                    ...
                    case 0x800:
                    {
                        ...
                        output->verbose(
                            ...
                            rvc_rs1, rvc_rs1, imm, imm);
                        bundle->addInstruction(
                            new VanadisSIMTAndImmInstruction(ins_address, hw_thr, options, rvc_rs1, rvc_rs1, imm));
                        decode_fault = false;
                    } break;
                    case 0xC00:
                    {
                        ...
                        case 0x0:
                        {
                            ...
                            case 0x0:
                            {
                                ...
                                output->verbose(
                                    ...
                                    rvc_rs1, rvc_rs1, rvc_rs2);
                                bundle->addInstruction(
                                    new VanadisSIMTSubInstruction<int64_t>(
                                        ins_address, hw_thr, options, rvc_rs1, rvc_rs1, rvc_rs2, true));
                                decode_fault = false;
                            } break;
                            case 0x20:
                            {
                                ...
                                output->verbose(
                                    ...
                                    rvc_rs1, rvc_rs1, rvc_rs2);
                                bundle->addInstruction(
                                    new VanadisSIMTXorInstruction(ins_address, hw_thr, options, rvc_rs1, rvc_rs1, rvc_rs2));
                                decode_fault = false;
                            } break;
                            case 0x40:
                            {
                                ...
                                output->verbose(
                                    ...
                                    rvc_rs1, rvc_rs1, rvc_rs2);
                                bundle->addInstruction(
                                    new VanadisSIMTOrInstruction(ins_address, hw_thr, options, rvc_rs1, rvc_rs1, rvc_rs2));
                                decode_fault = false;
                            } break;
                            case 0x60:
                            {
                                ...
                                output->verbose(
                                    ...
                                    rvc_rs1, rvc_rs1, rvc_rs2);
                                bundle->addInstruction(
                                    new VanadisSIMTAndInstruction(ins_address, hw_thr, options, rvc_rs1, rvc_rs1, rvc_rs2));
                                decode_fault = false;
                            } break;
                            }
                        } break;
                        case 0x1000:
                        {
                            ...
                            case 0x0:
                            {
                                ...
                                bundle->addInstruction(
                                    new VanadisSIMTSubInstruction<int32_t>(
                                        ins_address, hw_thr, options, rvc_rs1, rvc_rs1, rvc_rs2, false));
                                decode_fault = false;
                ...
                case 0xA000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> decode RVC JUMP pc=0x%" PRI_ADDR " + imm=%" PRId64 " = 0x%" PRI_ADDR "\n", ins_address,
                        imm_final, jump_target);
                    bundle->addInstruction(new VanadisSIMTJumpInstruction(
                        ins_address, hw_thr, options, 2, jump_target, VANADIS_NO_DELAY_SLOT));
                    decode_fault = false;
                } break;
                case 0xC000:
                {
                    ...
                    output->verbose(
                        CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "----> decode RVC BEQZ %" PRIu16 " jump to: 0x%" PRI_ADDR " + 0x%" PRI_ADDR " = 0x%" PRI_ADDR "\n",
                        rvc_rs1, ins_address, imm_final, ins_address + imm_final);
                    bundle->addInstruction(new VanadisSIMTBranchRegCompareImmInstruction<
                                           int64_t, REG_COMPARE_EQ>(
                        ins_address, hw_thr, options, 2, rvc_rs1, 0, imm_final, VANADIS_NO_DELAY_SLOT));
                    decode_fault = false;
                } break;
                ...
                case 0x8000:
                {
                    ...
                    if ( c_func_12 == 0 ) {
                        if ( c_func_12_rs2 == 0 ) {
                            ...
                            output->verbose(
                                CALL_INFO, 16, VANADIS_DBG_DECODER_FLG, "--------> (generates) RVC JR %" PRIu32 "\n", c_func_12_rs1);
                                bundle->addInstruction(new VanadisSIMTJumpRegInstruction(
                                ins_address, hw_thr, options, 2, c_func_12_rs1, VANADIS_NO_DELAY_SLOT));
                                decode_fault = false;
                        }
                        else {
