...
#undef PRINTF_BUFSIZ
    ...
    clock_tick_handler_ = new Clock::Handler<LlyrComponent,&LlyrComponent::tick>(this);
    ...
    mem_interface_ = loadUserSubComponent<SST::Interfaces::StandardMem>("iface", ComponentInfo::SHARE_NONE, &time_converter_,
                                        new StandardMem::Handler<LlyrComponent,&LlyrComponent::handleEvent>(this));
    ...
    if( !mem_interface_ ) {
        ...
        mem_interface_ = loadAnonymousSubComponent<SST::Interfaces::StandardMem>(interfaceName, "iface", 0, ComponentInfo::SHARE_PORTS |
            ComponentInfo::INSERT_STATS, interfaceParams, &time_converter_, new StandardMem::Handler<LlyrComponent,&LlyrComponent::handleEvent>(this));
