...
/* Begin class definition */
    ...
    IncoherentL1(ComponentId_t id, Params& params, Params& ownerParams, bool prefetch) : CoherenceController(id, params, ownerParams, prefetch) {
        ...
        cacheArray_ = new CacheArray<L1CacheLine>(debug_, lines, assoc, lineSize_, rmgr, ht);
        ...
        stat_eventstate_[(int)Command::GetSResp][IM] = registerStatistic<uint64_t>("stateEvent_GetSResp_IM");
