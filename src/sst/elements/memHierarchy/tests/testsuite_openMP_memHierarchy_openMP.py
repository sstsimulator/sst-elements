...
####
    ...
    def memH_test_template(self, omp_app):
        ...
        self.assertTrue(outtestresult, "openMP openMP Test - Cannot find string \"{0}\" in output file {1}".format(grepstr, outfile))
