...
#include "pse1x2nxr3.h"

Define_Module(PSE1x2NXR3);


PSE1x2NXR3::PSE1x2NXR3()
{
}
...
double PSE1x2NXR3::GetLatency(int indexIn, int indexOut)
{
	return latencyMatrix[indexIn][indexOut];
}

double PSE1x2NXR3::GetPropagationLoss(int indexIn, int indexOut, double wavelength)
{
	double IL = 0;
	int ringSet;
...
double PSE1x2NXR3::GetDropIntoRingLoss(int indexIn, int indexOut, double wavelength)
{
	double IL = 0;
	int ringSet;
...
double PSE1x2NXR3::GetPassByRingLoss(int indexIn, int indexOut, double wavelength)
{
	double IL = 0;
	int ringSet;
	bool resonant = IsInResonance(wavelength,ringSet);
...
double PSE1x2NXR3::GetPowerLevel(int state)
{
	switch(state)
	{
	case 0:
...
double PSE1x2NXR3::GetEnergyDissipation(int stateBefore, int stateAfter)
{
...
void PSE1x2NXR3::SetRoutingTable()
{
	// off resonance case
	routingTable[0] = 1;
	routingTable[1] = 0;
...
int PSE1x2NXR3::GetMultiRingRoutingTable(int index, int ringSet)
{
