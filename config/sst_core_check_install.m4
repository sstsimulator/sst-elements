...
AC_DEFUN([SST_CORE_CHECK_INSTALL], [
  ...
  AM_CPPFLAGS="$SST_CPPFLAGS $PYTHON_CPPFLAGS $BOOST_CPPFLAGS -I$SST_PREFIX/include/sst/core -I$SST_PREFIX/include"
  AM_CFLAGS="$SST_CFLAGS"
  AM_CXXFLAGS="$SST_CXXFLAGS"
  AM_LDFLAGS="$SST_LDFLAGS $BOOST_LDFLAGS $PYTHON_LDFLAGS"
