 ...
 *
 */
class MemNICSub : public MemLinkBase {

public:
    
    /* Constructor */
    MemNICSub(Component * comp, Params &params);
    ...
    class MemRtrEvent : public SST::Event {
        public:
            ...
            ImplementSerializable(SST::MemHierarchy::MemNICSub::MemRtrEvent);
    };
    ...
    class InitMemRtrEvent : public MemRtrEvent {
        ...
        ImplementSerializable(SST::MemHierarchy::MemNICSub::InitMemRtrEvent);
    };
