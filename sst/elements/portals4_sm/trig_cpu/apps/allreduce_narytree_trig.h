...
class allreduce_narytree_triggered :  public application {
public:
    allreduce_narytree_triggered(trig_cpu *cpu) : application(cpu)
    {
...
private:
    ...
    allreduce_narytree_triggered(const application& a);
