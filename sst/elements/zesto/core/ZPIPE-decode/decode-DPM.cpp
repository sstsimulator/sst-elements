...
core_decode_DPM_t::check_target(struct Mop_t * const Mop)
{
  ...
  else /* branch or REP */
  {
    ...
    {
      // We assume that even for control instructions whose target addresses are dependent on immediate offsets and PC, are only resolved during execute rather than decode
