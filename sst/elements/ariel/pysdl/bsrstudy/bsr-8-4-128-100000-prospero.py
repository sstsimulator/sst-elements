...
#    sst.addcompparam(id, "fastmempagecount", "32768")
#    sst.addcompparam(id, "tracecores", "1")    
#    sst.setcomprank(id, 0)

#    sst.addcompparam(id, "appargcount", "6")
#    sst.addcompparam(id, "apparg0", "100000")
#    sst.addcompparam(id, "apparg1", "1")
#    sst.addcompparam(id, "apparg2", "134217728")
...
#    sst.addcompparam(id, "apparg5", "8")
    ...
    for x in range(0, 8):
       pros = sst.createcomponent("prospero" + str(x), "prospero.prospero")
       sst.addcompparam(pros, "outputlevel", "0")
       sst.addcompparam(pros, "tracetype", "file")
       sst.addcompparam(pros, "cache_line", "64")
       sst.addcompparam(pros, "traceformat", "1")
#       sst.addcompparam(pros, "physlimit", "8192")
       sst.addcompparam(pros, "trace", "core_trace_" + str(x))
       sst.addcomplink(pros, "cpu_cache_link_" + str(x), "cache_link", "1ns")
...
#       sst.addcomplink(id, "cpu_cache_link_" + str(x), "cache_link_" + str(x), "1ns")
    ...
    sst.addcompparam(nearMemory, "mem_size", "128")
...
#    sst.addcompparam(dirctrl0, "entryCacheSize", "16384")
    ...
    sst.setcomprank(dirctrl1, 0)
    sst.addcompparam(dirctrl1, "network_bw", "1GHz")
    sst.addcompparam(dirctrl1, "addrRangeStart", "0x8000000")
    sst.addcompparam(dirctrl1, "addrRangeEnd",   "0x100000000")
