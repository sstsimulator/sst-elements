...
/* KBW: I've decided that this recursive stuff is basically a nonsensical
 * distraction. There is currently NO WAY to lock a mempool and do a
 * "transaction", so it's all rather besides the point. Additionally, the
 * non-recursive stuff here is fundamentally broken, and I don't have time to
 * figure out why. */
