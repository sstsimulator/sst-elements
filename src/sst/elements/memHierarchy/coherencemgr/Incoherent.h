...
/* Class definition */
    ...
    Incoherent(SST::ComponentId_t id, Params& params, Params& ownerParams, bool prefetch) : CoherenceController(id, params, ownerParams, prefetch) {
        ...
        stat_eventstate_[(int)Command::PutE][IS] = registerStatistic<uint64_t>("stateEvent_PutE_IS");
        stat_eventstate_[(int)Command::PutE][IM] = registerStatistic<uint64_t>("stateEvent_PutE_IM");
        stat_eventstate_[(int)Command::PutE][I_B] = registerStatistic<uint64_t>("stateEvent_PutE_IB");
        stat_eventstate_[(int)Command::PutE][S_B] = registerStatistic<uint64_t>("stateEvent_PutE_SB");
        ...
        stat_eventstate_[(int)Command::PutM][IS] = registerStatistic<uint64_t>("stateEvent_PutM_IS");
        stat_eventstate_[(int)Command::PutM][IM] = registerStatistic<uint64_t>("stateEvent_PutM_IM");
        stat_eventstate_[(int)Command::PutM][I_B] = registerStatistic<uint64_t>("stateEvent_PutM_IB");
        stat_eventstate_[(int)Command::PutM][S_B] = registerStatistic<uint64_t>("stateEvent_PutM_SB");
        ...
        stat_eventstate_[(int)Command::FlushLine][IS] = registerStatistic<uint64_t>("stateEvent_FlushLine_IS");
        stat_eventstate_[(int)Command::FlushLine][IM] = registerStatistic<uint64_t>("stateEvent_FlushLine_IM");
        stat_eventstate_[(int)Command::FlushLine][I_B] = registerStatistic<uint64_t>("stateEvent_FlushLine_IB");
        stat_eventstate_[(int)Command::FlushLine][S_B] = registerStatistic<uint64_t>("stateEvent_FlushLine_SB");
        ...
        stat_eventstate_[(int)Command::FlushLineInv][IS] = registerStatistic<uint64_t>("stateEvent_FlushLineInv_IS");
        stat_eventstate_[(int)Command::FlushLineInv][IM] = registerStatistic<uint64_t>("stateEvent_FlushLineInv_IM");
        stat_eventstate_[(int)Command::FlushLineInv][I_B] = registerStatistic<uint64_t>("stateEvent_FlushLineInv_IB");
        stat_eventstate_[(int)Command::FlushLineInv][S_B] = registerStatistic<uint64_t>("stateEvent_FlushLineInv_SB");
