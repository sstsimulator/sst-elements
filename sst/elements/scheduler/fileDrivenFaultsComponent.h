...
#ifndef SST_SCHEDULER_FILEDRIVENFAULTCOMPONENT_H__
#define SST_SCHEDULER_FILEDRIVENFAULTCOMPONENT_H__
...
namespace SST{
	...
	namespace Scheduler{
		...
		class fileDrivenFaultsComponent : public SST::Component{
			public:
				fileDrivenFaultsComponent();
				fileDrivenFaultsComponent( SST::ComponentId_t id, SST::Params& params );
				~fileDrivenFaultsComponent();
