...
link_l2_scratch0.connect( (comp_l2_0, "lowlink", "100ps"), (comp_scratch0, "highlink", "100ps") )
link_l2_scratch1 = sst.Link("link_cpu1_scratch1")
link_l2_scratch1.connect( (comp_l2_1, "lowlink", "100ps"), (comp_scratch1, "highlink", "100ps") )
