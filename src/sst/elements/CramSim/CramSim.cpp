...
static SubComponent*
create_c_HBM2AddrMap(Component * owner, Params& params) {
	return new c_HBM2AddrMap(owner, params);
}
...
static SubComponent*
create_c_ReadFirstTxnScheduler(Component * owner, Params& params) {
	return new c_ReadFirstTxnScheduler(owner, params);
}
...
static const ElementInfoSubComponent CramSimSubComponents[] = {
		{ "c_HBM2AddrMap", 							// Name
		  ...
		  NULL, 										// PrintHelp
		  create_c_HBM2AddrMap, 						// Allocator
		...
		{ "c_ReadFirstTxnScheduler",	 							// Name
		"Read First Transaction Scheduler",				 			// Description
		NULL, 										// PrintHelp
		create_c_ReadFirstTxnScheduler, 							// Allocator
		c_TxnScheduler_params, 							// Parameters
		c_TxnScheduler_stats,
				"SST::CramSim::Controller::TxnScheduler" 			// Category
		},
