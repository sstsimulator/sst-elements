...
public:
    VanadisFPMultiplyInstruction(const uint64_t addr, const uint32_t hw_thr, const VanadisDecoderOptions* isa_opts,
    ...
    VanadisFPMultiplyInstruction* clone() { return new VanadisFPMultiplyInstruction(*this); }
