...
class CPU_Builder:
    ...
    def build( self, prefix, nodeId, cpuId ):
        ...
        ## CPU Dcache NIC
        cpuDcache_nic = cpuDcacheIf.setSubComponent("memlink", "memHierarchy.MemNIC")
        ...
        l1dcache_nic = cpu_l1dcache.setSubComponent("cpulink", "memHierarchy.MemNIC")
        ...
        link_cpu_rtr.connect( (cpuDcache_nic, "port", "1ns"), (chiprtr, "port0", "1ns") )

        link_l1dcache_rtr = sst.Link(prefix+".link_cpu_l1d")
        link_l1dcache_rtr.connect( (l1dcache_nic, "port", '1ns'), (chiprtr, "port1", "1ns") )

        # Connect balarMMIO to chiprtr?
        link_balarmmio_rtr = sst.Link(prefix+".link_balarmmio")
        link_balarmmio_rtr.connect( (mmio_nic, "port", "1ns"), (chiprtr, "port2", "1ns"))
        ...
        link_dma_rtr.connect( (dma_nic, "port", "1ns"), (chiprtr, "port3", "1ns"))
        ...
        link_cpu_l1icache_link.connect( (cpuIcacheIf, "port", "1ns"), (l1icache_2_cpu, "port", "1ns") )
