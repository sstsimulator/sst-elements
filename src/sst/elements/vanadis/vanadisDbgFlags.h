...
#define VANADIS_DBG_INS_LDR_FLG  1
#define VANADIS_DBG_DECODER_FLG  1
#define VANADIS_DBG_ISSUE_FLG  0
#define VANADIS_DBG_CYCLE_FLG  0
#define VANADIS_DBG_RETIRE_FLG  0
#define VANADIS_DBG_CHECKPOINT  0
