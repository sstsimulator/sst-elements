...
/* Event handlers */
    ...
    CacheAction handleCacheResponse(MemEvent* responseEvent, CacheLine* dirLine, MemEvent* origRequest);
    CacheAction handleFetchResponse(MemEvent* responseEvent, CacheLine* dirLine, MemEvent* origRequest);
