...
//        std::vector<uint16_t>* get_ovcs_list( uint16_t );
    ...
    private:
        void route_x_y( const Flit* hf );
        void route_twonode( const Flit* hf );
        void route_torus(const Flit* hf );
        void route_ring( const Flit* hf );
        void route_ring_unidirection( const Flit* hf );
