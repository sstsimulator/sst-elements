...
link_c1_l1cache.connect( (iface, "port", "500ps"), (comp_c1_l1cache, "high_network_0", "500ps") )
...
link_c2_l1cache.connect( (iface, "port", "500ps"), (comp_c2_l1cache, "high_network_0", "500ps") )
...
link_c3_l1cache.connect( (iface3, "port", "500ps"), (comp_c3_l1cache, "high_network_0", "500ps") )
