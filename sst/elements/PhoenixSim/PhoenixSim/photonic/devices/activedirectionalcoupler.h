...
#ifndef __ACTIVEDIRECTIONALCOUPLER_H__
#define __ACTIVEDIRECTIONALCOUPLER_H__
 ...
 */
class ActiveDirectionalCoupler : public ActiveElement
{
	private:

		double CouplingLength;
	...
	public:
		ActiveDirectionalCoupler();
		virtual ~ActiveDirectionalCoupler();
};
