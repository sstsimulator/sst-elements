...
AC_DEFUN([SST_CORE_CHECK_INSTALL], [
  ...
  TEMP_CPPFLAGS="$SST_CPPFLAGS $PYTHON_CPPFLAGS $BOOST_CPPFLAGS -I$SST_PREFIX/include/sst/core -I$SST_PREFIX/include"
  TEMP_CFLAGS="$SST_CFLAGS"
  TEMP_CXXFLAGS="$SST_CXXFLAGS"
  TEMP_LDFLAGS="$SST_LDFLAGS $BOOST_LDFLAGS $PYTHON_LDFLAGS"
