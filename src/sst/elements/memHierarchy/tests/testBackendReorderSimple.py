...
link_cache_net_0.connect( (l3_mlink, "port", "500ps"), (comp_chiprtr, "port1", "200ps") )
link_dir_net_0 = sst.Link("link_dir_net_0")
link_dir_net_0.connect( (comp_chiprtr, "port0", "200ps"), (dir_clink, "port", "200ps") )
link_dir_mem_link = sst.Link("link_dir_mem_link")
link_dir_mem_link.connect( (dir_mlink, "port", "500ps"), (comp_memory, "direct_link", "500ps") )
