...
void Arbiter_SR8x8::init(string id, int level, int numX, int numY, int vc,
...
int Arbiter_SR8x8::route(ArbiterRequestMsg* rmsg) {
...
int Arbiter_SR8x8::getUpPort(ArbiterRequestMsg* rmsg, int lev) {
...
int Arbiter_SR8x8::getDownPort(ArbiterRequestMsg* rmsg, int lev) {
