...
#define InstallRISCV64FuncPtr( funcName ) install( VANADIS_SYSCALL_RISCV_##funcName, MakeRISCV64FuncPtr( funcName ) )
#define MakeRISCV64FuncPtr( x ) std::bind(&VanadisRISCV64OSHandler2< T1,BitType,RegZero,OsCodeReg,LinkReg >::x, this, std::placeholders::_1 )
